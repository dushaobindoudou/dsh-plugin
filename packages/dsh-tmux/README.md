...
[![npm](https://img.shields.io/npm/v/dsh-tmux.svg)](https://www.npmjs.com/package/dsh-tmux)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**tmux surface for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Panes as sessions - spawn a bot per pane, live status in the status bar, pane titles as presence; terminal-native parallelism for dsh-bot fleets.
