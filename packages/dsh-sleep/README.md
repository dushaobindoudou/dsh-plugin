...
[![npm](https://img.shields.io/npm/v/dsh-sleep.svg)](https://www.npmjs.com/package/dsh-sleep)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Sleep tracker tools for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Sleep tracker tools for dsh. (Recorded from the npm registry at import time.)
