...
[![npm](https://img.shields.io/npm/v/dsh-invoice.svg)](https://www.npmjs.com/package/dsh-invoice)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Invoice tools for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Invoice tools for dsh. (Recorded from the npm registry at import time.)
