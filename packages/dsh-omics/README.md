...
[![npm](https://img.shields.io/npm/v/dsh-omics.svg)](https://www.npmjs.com/package/dsh-omics)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Omics - the suffix of scale** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Genomics, proteomics, metabolomics - the measure-everything lane; find the pattern.
