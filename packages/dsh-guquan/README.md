...
[![npm](https://img.shields.io/npm/v/dsh-guquan.svg)](https://www.npmjs.com/package/dsh-guquan)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Guquan - equity, in Chinese** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

股权 - ownership stakes, cap tables, ESOP - the equity lane in pinyin; kin to dsh-shares.
