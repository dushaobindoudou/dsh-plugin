...
[![npm](https://img.shields.io/npm/v/dsh-shoukuan.svg)](https://www.npmjs.com/package/dsh-shoukuan)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Shoukuan (收款) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Collections reconciled - payments matched to invoices (dsh-fapiao), partials tracked, the cash-in digest every morning.
