...
[![npm](https://img.shields.io/npm/v/dsh-groundstation.svg)](https://www.npmjs.com/package/dsh-groundstation)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Groundstation - the other half of every link** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Antennas, dish farms, scheduling - the ground-segment lane; satellites are useless without listeners.
