...
[![npm](https://img.shields.io/npm/v/dsh-square.svg)](https://www.npmjs.com/package/dsh-square)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Square bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

POS and payments lane - sales digests, catalog reads, and refund drafts over the Square API.
