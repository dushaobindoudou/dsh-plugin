...
[![npm](https://img.shields.io/npm/v/dsh-metamask.svg)](https://www.npmjs.com/package/dsh-metamask)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**MetaMask-facing bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Snaps and connection flows exposed to harness sessions - signature requests surfaced through the approval seam, never auto-signed.
