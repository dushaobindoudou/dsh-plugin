...
[![npm](https://img.shields.io/npm/v/dsh-notcoin.svg)](https://www.npmjs.com/package/dsh-notcoin)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Notcoin - the tap to earn** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The telegram mini-game that onboarded millions - the tap-to-earn lane; kin to dsh-hamster.
