...
[![npm](https://img.shields.io/npm/v/dsh-marathon.svg)](https://www.npmjs.com/package/dsh-marathon)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Marathon runs for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The ultra lane - week-long objectives, milestone splits, steady-state pacing with recovery between legs.
