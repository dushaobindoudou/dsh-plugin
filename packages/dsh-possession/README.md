...
[![npm](https://img.shields.io/npm/v/dsh-possession.svg)](https://www.npmjs.com/package/dsh-possession)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Possession - who has the ball** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The base currency of soccer analytics - shots per possession, points per possession.
