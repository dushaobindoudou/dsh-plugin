...
[![npm](https://img.shields.io/npm/v/dsh-adapt.svg)](https://www.npmjs.com/package/dsh-adapt)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Adaptation layer for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Behavior that shifts with the task - strategies re-weighted by outcome signal, no retraining required.
