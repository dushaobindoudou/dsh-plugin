...
[![npm](https://img.shields.io/npm/v/dsh-mev.svg)](https://www.npmjs.com/package/dsh-mev)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Mev - the invisible tax** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Maximal extractable value - the profit skimmed by reordering your transaction; the darkest arbitrage lane in web3.
