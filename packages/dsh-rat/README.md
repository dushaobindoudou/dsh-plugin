...
[![npm](https://img.shields.io/npm/v/dsh-rat.svg)](https://www.npmjs.com/package/dsh-rat)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Rat - the resourceful zodiac** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The resourceful twin seat of the first zodiac sign - survives everything, thrives in the margins.
