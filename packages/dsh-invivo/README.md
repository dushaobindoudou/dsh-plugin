...
[![npm](https://img.shields.io/npm/v/dsh-invivo.svg)](https://www.npmjs.com/package/dsh-invivo)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Invivo - in the living** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Experiments inside organisms - the preclinical lane; kin to dsh-invitro.
