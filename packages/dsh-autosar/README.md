...
[![npm](https://img.shields.io/npm/v/dsh-autosar.svg)](https://www.npmjs.com/package/dsh-autosar)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Autosar - the car software standard** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The architecture every automaker agreed to follow - the standardization lane of automotive code.
