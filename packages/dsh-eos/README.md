...
[![npm](https://img.shields.io/npm/v/dsh-eos.svg)](https://www.npmjs.com/package/dsh-eos)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Eos - the record raise** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The four-billion-dollar 2018 ICO - the infra lane that taught the market about overpromising.
