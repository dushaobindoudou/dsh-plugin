...
[![npm](https://img.shields.io/npm/v/dsh-ansible.svg)](https://www.npmjs.com/package/dsh-ansible)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Ansible toolkit for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Ansible toolkit for dsh. (Recorded from the npm registry at import time.)
