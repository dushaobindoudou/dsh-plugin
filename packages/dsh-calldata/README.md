...
[![npm](https://img.shields.io/npm/v/dsh-calldata.svg)](https://www.npmjs.com/package/dsh-calldata)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Calldata - the cheapest input** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Read-only arguments on-chain - the data lane of the EVM; how contracts hear without storing.
