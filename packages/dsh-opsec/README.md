...
[![npm](https://img.shields.io/npm/v/dsh-opsec.svg)](https://www.npmjs.com/package/dsh-opsec)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Opsec - operational security** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

What you reveal is what they use - the discipline lane; metadata leaks, screenshots leak, pets must not leak.
