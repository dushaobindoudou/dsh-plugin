...
[![npm](https://img.shields.io/npm/v/dsh-scroll.svg)](https://www.npmjs.com/package/dsh-scroll)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Scroll - the zkEVM that shipped** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Type-2 zkEVM, bytecode compatible - the incremental path to zk everything.
