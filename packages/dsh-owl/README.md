...
[![npm](https://img.shields.io/npm/v/dsh-owl.svg)](https://www.npmjs.com/package/dsh-owl)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Owl - the watcher for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Night-shift vigilance - watches long runs and overnight batches, silent unless something needs you; the calm counterpart to dsh-xiaotian.
