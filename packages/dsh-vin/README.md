...
[![npm](https://img.shields.io/npm/v/dsh-vin.svg)](https://www.npmjs.com/package/dsh-vin)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Vin - the vehicle fingerprint** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Seventeen characters, one specific car - the identity lane for anything with wheels.
