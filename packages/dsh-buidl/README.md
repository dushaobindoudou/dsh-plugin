...
[![npm](https://img.shields.io/npm/v/dsh-buidl.svg)](https://www.npmjs.com/package/dsh-buidl)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Buidl - the fund that BlackRock named** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The tokenized treasury fund that told every CFO this was real - the institutional-blessing lane.
