...
[![npm](https://img.shields.io/npm/v/dsh-options.svg)](https://www.npmjs.com/package/dsh-options)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Options analytics for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Options analytics for dsh. (Recorded from the npm registry at import time.)
