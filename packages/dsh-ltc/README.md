...
[![npm](https://img.shields.io/npm/v/dsh-ltc.svg)](https://www.npmjs.com/package/dsh-ltc)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Ltc - the silver to gold** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Litecoin four times faster - the oldest altcoin still standing; scrypt history in one ticker.
