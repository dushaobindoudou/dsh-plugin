...
[![npm](https://img.shields.io/npm/v/dsh-gongjijin.svg)](https://www.npmjs.com/package/dsh-gongjijin)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Gongjijin (公积金) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The housing-fund reads - balance, contribution history, and withdrawal-eligibility digests.
