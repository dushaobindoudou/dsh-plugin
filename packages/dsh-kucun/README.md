...
[![npm](https://img.shields.io/npm/v/dsh-kucun.svg)](https://www.npmjs.com/package/dsh-kucun)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Kucun (库存) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Inventory as living data - counts, turns, aging stock flagged, and the replenishment draft before the shelf goes empty.
