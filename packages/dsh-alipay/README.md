...
[![npm](https://img.shields.io/npm/v/dsh-alipay.svg)](https://www.npmjs.com/package/dsh-alipay)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Alipay bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The default China payment lane - bill reads, fund drafts, and verification all behind the approval seam; credentials never touch the session.
