...
[![npm](https://img.shields.io/npm/v/dsh-baoyou.svg)](https://www.npmjs.com/package/dsh-baoyou)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Baoyou (包邮) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The free-shipping ritual - threshold math, cart-splitting suggestions, and the checkout digests the commerce walls cite.
