...
[![npm](https://img.shields.io/npm/v/dsh-zen.svg)](https://www.npmjs.com/package/dsh-zen)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Zen mode for the dsh web GUI** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Distraction-free single-column typography - hide chrome, widen the conversation, keep the keyboard.
