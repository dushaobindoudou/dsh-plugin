...
[![npm](https://img.shields.io/npm/v/dsh-npc.svg)](https://www.npmjs.com/package/dsh-npc)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**NPC engine for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Agents as characters - personas with memory, motivation, and dialogue trees; the lane where dsh-bots plays dress-up.
