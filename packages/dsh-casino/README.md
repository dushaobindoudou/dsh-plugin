...
[![npm](https://img.shields.io/npm/v/dsh-casino.svg)](https://www.npmjs.com/package/dsh-casino)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Casino - the house** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The house always wins - unless the house is you: the token-ledger lane where dsh-pixiu keeps the books.
