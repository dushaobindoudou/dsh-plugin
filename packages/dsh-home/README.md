...
[![npm](https://img.shields.io/npm/v/dsh-home.svg)](https://www.npmjs.com/package/dsh-home)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Smart-home lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The house as a session - scenes, energy, and the morning brief from your actual rooms; local-first, cloud optional. Registered externally; promoted into the curated core.
