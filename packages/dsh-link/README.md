...
[![npm](https://img.shields.io/npm/v/dsh-link.svg)](https://www.npmjs.com/package/dsh-link)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Share links for dsh sessions** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Publish a read-only snapshot of a conversation - one command, one URL, no account.
