...
[![npm](https://img.shields.io/npm/v/dsh-apollo.svg)](https://www.npmjs.com/package/dsh-apollo)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Apollo - the name that means we went** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The program that put humans on the Moon - the lunar lane; the most borrowed name in branding.
