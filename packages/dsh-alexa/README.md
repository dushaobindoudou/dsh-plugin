...
[![npm](https://img.shields.io/npm/v/dsh-alexa.svg)](https://www.npmjs.com/package/dsh-alexa)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Alexa-facing bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The Amazon assistant seam - skills that surface dsh bot results as spoken briefings.
