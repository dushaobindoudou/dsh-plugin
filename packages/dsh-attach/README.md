...
[![npm](https://img.shields.io/npm/v/dsh-attach.svg)](https://www.npmjs.com/package/dsh-attach)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Attachments for prompts** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Drag-and-drop files, screenshots, and images into any session; paste-as-file; everything lands in the workspace, not in chat limbo.
