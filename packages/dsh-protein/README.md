...
[![npm](https://img.shields.io/npm/v/dsh-protein.svg)](https://www.npmjs.com/package/dsh-protein)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Protein - the machines that do everything** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Twenty letters folded into workers - the proteomics lane; structure is function.
