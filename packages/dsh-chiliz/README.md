...
[![npm](https://img.shields.io/npm/v/dsh-chiliz.svg)](https://www.npmjs.com/package/dsh-chiliz)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Chiliz - the fan token chain** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Socios and fan engagement - sports teams as tokens; the fan-economy lane.
