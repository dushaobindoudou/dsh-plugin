...
[![npm](https://img.shields.io/npm/v/dsh-factor.svg)](https://www.npmjs.com/package/dsh-factor)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Factor lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Quant factors as data - exposures computed, decay tracked, and the research diary every strategy notebook needs.
