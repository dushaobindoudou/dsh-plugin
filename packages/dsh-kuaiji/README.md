...
[![npm](https://img.shields.io/npm/v/dsh-kuaiji.svg)](https://www.npmjs.com/package/dsh-kuaiji)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Kuaiji (会计) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The accountant seat - standards-aware summaries, month-end close checklists, and the reports that write themselves from the ledger.
