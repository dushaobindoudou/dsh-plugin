...
[![npm](https://img.shields.io/npm/v/dsh-hupu.svg)](https://www.npmjs.com/package/dsh-hupu)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Hupu (虎扑) bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The straight-man forum - thread reads and comment digests, sports takes graded by the crowd.
