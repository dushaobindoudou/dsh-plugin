...
[![npm](https://img.shields.io/npm/v/dsh-tuangou.svg)](https://www.npmjs.com/package/dsh-tuangou)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Tuangou (团购) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The group-buy ritual - deal aggregation, group-joining drafts, and the neighborhood buying calendar.
