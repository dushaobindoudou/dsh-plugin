...
[![npm](https://img.shields.io/npm/v/dsh-carry.svg)](https://www.npmjs.com/package/dsh-carry)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Carry - get paid to wait** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Positive carry is the strategy that never sleeps - the yield-differential lane.
