...
[![npm](https://img.shields.io/npm/v/dsh-ion.svg)](https://www.npmjs.com/package/dsh-ion)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Ion - the engine that whispers** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Ion propulsion - tiny thrust, months of patience; the high-efficiency lane.
