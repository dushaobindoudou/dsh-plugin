...
[![npm](https://img.shields.io/npm/v/dsh-tasks.svg)](https://www.npmjs.com/package/dsh-tasks)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Durable task tracking for dsh sessions** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Checklist state that survives compaction and session switches, linked from planner trees and surfaced in the GUI.
