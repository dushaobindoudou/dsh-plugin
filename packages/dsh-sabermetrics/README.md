...
[![npm](https://img.shields.io/npm/v/dsh-sabermetrics.svg)](https://www.npmjs.com/package/dsh-sabermetrics)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Sabermetrics - bill james made numbers play** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The empirical study of baseball - the founding analytics lane; Moneyball made it cinema.
