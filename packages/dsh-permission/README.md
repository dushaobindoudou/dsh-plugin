...
[![npm](https://img.shields.io/npm/v/dsh-permission.svg)](https://www.npmjs.com/package/dsh-permission)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Permission scopes for dsh tools** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Grant a session read-only, write-scope, or network access explicitly - scopes shown live in the header.
