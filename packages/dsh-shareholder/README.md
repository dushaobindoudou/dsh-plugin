...
[![npm](https://img.shields.io/npm/v/dsh-shareholder.svg)](https://www.npmjs.com/package/dsh-shareholder)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Shareholder - the register lives on-chain** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Who owns what, right now, provably - the cap-table lane; proxy season without the mail.
