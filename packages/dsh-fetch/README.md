...
[![npm](https://img.shields.io/npm/v/dsh-fetch.svg)](https://www.npmjs.com/package/dsh-fetch)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Fetch - the agent economy** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Machine-to-machine payments and knowledge - kin to dsh-fet; our own dsh-bots lane on-chain.
