...
[![npm](https://img.shields.io/npm/v/dsh-zhipu.svg)](https://www.npmjs.com/package/dsh-zhipu)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The company-spelled form of the GLM provider bridge** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Compatibility name: the Zhipu GLM bridge ships as dsh-glm; this form keeps the company spelling installable.
