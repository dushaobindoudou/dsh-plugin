...
[![npm](https://img.shields.io/npm/v/dsh-matchmove.svg)](https://www.npmjs.com/package/dsh-matchmove)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Matchmove - the camera that matches** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Track the plate, rebuild the move - the 3D-tracking lane; CG must inherit the lens.
