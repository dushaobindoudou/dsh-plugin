...
[![npm](https://img.shields.io/npm/v/dsh-negotiate.svg)](https://www.npmjs.com/package/dsh-negotiate)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**work & hiring** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Negotiate - the second offer is the real one
