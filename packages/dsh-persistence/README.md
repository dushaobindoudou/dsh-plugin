...
[![npm](https://img.shields.io/npm/v/dsh-persistence.svg)](https://www.npmjs.com/package/dsh-persistence)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Persistence layer for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

State that survives everything - runs, checkpoints, and artifacts stored durably, restored exactly.
