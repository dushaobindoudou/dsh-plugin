...
[![npm](https://img.shields.io/npm/v/dsh-feihualing.svg)](https://www.npmjs.com/package/dsh-feihualing)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Feihualing - the poetry duel** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

飞花令 - take turns reciting verses that contain the chosen word; the Tang-dynasty drinking game, now a national pastime.
