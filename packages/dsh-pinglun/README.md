...
[![npm](https://img.shields.io/npm/v/dsh-pinglun.svg)](https://www.npmjs.com/package/dsh-pinglun)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Pinglun - the comment section** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

评论 - where the real show happens, as every Chinese netizen knows; the reply lane.
