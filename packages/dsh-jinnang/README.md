...
[![npm](https://img.shields.io/npm/v/dsh-jinnang.svg)](https://www.npmjs.com/package/dsh-jinnang)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Jinnang (锦囊) - the pouch of stratagems** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Zhuge Liang handed out sealed pouches - open one in crisis, inside was exactly the right plan. The on-demand-advice lane: open a pouch, get the next step.
