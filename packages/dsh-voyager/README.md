...
[![npm](https://img.shields.io/npm/v/dsh-voyager.svg)](https://www.npmjs.com/package/dsh-voyager)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Voyager - the farthest machines** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Launched 1977, still transmitting from interstellar space - the grand-tour lane; the golden records.
