...
[![npm](https://img.shields.io/npm/v/dsh-huya.svg)](https://www.npmjs.com/package/dsh-huya)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Huya (虎牙) bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Game-streaming lane - live reads, chat triage, and highlight digests; the Twitch of China beside dsh-twitch.
