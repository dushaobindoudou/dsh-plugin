...
[![npm](https://img.shields.io/npm/v/dsh-pancakeswap.svg)](https://www.npmjs.com/package/dsh-pancakeswap)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Pancakeswap - the bnb dex** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The biggest kitchen on BNB chain - forks as business model, done right.
