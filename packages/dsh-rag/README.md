...
[![npm](https://img.shields.io/npm/v/dsh-rag.svg)](https://www.npmjs.com/package/dsh-rag)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Retrieval-augmented answers over workspace docs** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Local index, cited chunks, no external service - answers quote the file and line they came from.
