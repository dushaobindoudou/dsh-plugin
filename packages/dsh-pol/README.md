...
[![npm](https://img.shields.io/npm/v/dsh-pol.svg)](https://www.npmjs.com/package/dsh-pol)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Pol - the polygon ticker** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

MATIC became POL - kin to dsh-polygon; the agglayer era.
