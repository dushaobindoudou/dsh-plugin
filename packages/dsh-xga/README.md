...
[![npm](https://img.shields.io/npm/v/dsh-xga.svg)](https://www.npmjs.com/package/dsh-xga)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Xga - expected goals against** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Defense, quantified - the defensive lane; how good was the block, really.
