...
[![npm](https://img.shields.io/npm/v/dsh-rps.svg)](https://www.npmjs.com/package/dsh-rps)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Rock paper scissors for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The coin flip with psychology - pattern detection on human choices, exploit cautiously, best-of-N with style.
