...
[![npm](https://img.shields.io/npm/v/dsh-keccak.svg)](https://www.npmjs.com/package/dsh-keccak)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Keccak - the hash behind eth** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The permutation behind Ethereum hashing - the cryptography seat; fast, standardized, everywhere in the EVM.
