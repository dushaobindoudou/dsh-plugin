...
[![npm](https://img.shields.io/npm/v/dsh-crane.svg)](https://www.npmjs.com/package/dsh-crane)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Crane - the immortal companion** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

仙鹤 - rides with immortals, stands for longevity; the elegant form for sessions that run for days.
