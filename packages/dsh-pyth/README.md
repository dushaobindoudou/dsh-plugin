...
[![npm](https://img.shields.io/npm/v/dsh-pyth.svg)](https://www.npmjs.com/package/dsh-pyth)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Pyth - first-party price feeds** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Exchanges sign prices directly on-chain - the oracle lane built for markets that move in milliseconds.
