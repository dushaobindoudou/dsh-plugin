...
[![npm](https://img.shields.io/npm/v/dsh-circuitbreaker.svg)](https://www.npmjs.com/package/dsh-circuitbreaker)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Circuitbreaker - the pause button** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Seven percent down and the market breathes - the guardrail lane; code-level risk controls.
