...
[![npm](https://img.shields.io/npm/v/dsh-nuxt.svg)](https://www.npmjs.com/package/dsh-nuxt)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Nuxt toolkit for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Nuxt toolkit for dsh. (Recorded from the npm registry at import time.)
