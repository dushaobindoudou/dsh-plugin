...
[![npm](https://img.shields.io/npm/v/dsh-goat.svg)](https://www.npmjs.com/package/dsh-goat)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Goat - the greatest of all time** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The cross-era debate - the legacy lane; rings versus stats, never settled.
