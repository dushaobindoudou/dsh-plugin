...
[![npm](https://img.shields.io/npm/v/dsh-ens.svg)](https://www.npmjs.com/package/dsh-ens)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Ens - your name on the chain** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Human-readable addresses - the naming lane; every wallet wants one.
