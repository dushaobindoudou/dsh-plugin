...
[![npm](https://img.shields.io/npm/v/dsh-oa.svg)](https://www.npmjs.com/package/dsh-oa)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The OA (办公自动化) bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The Chinese intranet - approvals, announcements, and workflows read into sessions; the office system every B-end plan starts from.
