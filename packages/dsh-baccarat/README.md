...
[![npm](https://img.shields.io/npm/v/dsh-baccarat.svg)](https://www.npmjs.com/package/dsh-baccarat)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Baccarat lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The casino classic as a strategy sandbox - shoe tracking, streak math, and bankroll discipline; play money only, lessons free.
