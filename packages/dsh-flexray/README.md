...
[![npm](https://img.shields.io/npm/v/dsh-flexray.svg)](https://www.npmjs.com/package/dsh-flexray)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Flexray - deterministic by design** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Time-triggered in-vehicle networking - when brake-by-wire cannot tolerate jitter; the hard-realtime lane.
