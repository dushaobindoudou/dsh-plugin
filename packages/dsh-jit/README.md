...
[![npm](https://img.shields.io/npm/v/dsh-jit.svg)](https://www.npmjs.com/package/dsh-jit)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Jit - just in time** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Arrive exactly when needed, never before, never after - inventory at zero; also the compile lane, just-in-time.
