...
[![npm](https://img.shields.io/npm/v/dsh-immutable.svg)](https://www.npmjs.com/package/dsh-immutable)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Immutable - the web3 gaming L2** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Passport, zk orderbooks, zero gas for gamers - the game-studio chain lane.
