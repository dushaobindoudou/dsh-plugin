...
[![npm](https://img.shields.io/npm/v/dsh-coverage.svg)](https://www.npmjs.com/package/dsh-coverage)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Agent edit coverage map** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Which files, functions, and paths the agent actually touched - a coverage report for agent work, diffable run over run.
