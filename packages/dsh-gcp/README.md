...
[![npm](https://img.shields.io/npm/v/dsh-gcp.svg)](https://www.npmjs.com/package/dsh-gcp)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**GCP toolkit for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

GCP toolkit for dsh agents. (Recorded from the npm registry at import time.)
