...
- Development moved into the [dsh-plugin monorepo](https://github.com/dushaobindoudou/dsh-plugin);
  `repository`, `bugs`, and `homepage` now point there. No functional changes.
...
[0.2.0]: https://github.com/dushaobindoudou/dsh-plugin/releases/tag/dsh-selfrepair-vv0.2.0
[0.1.0]: https://github.com/dushaobindoudou/dsh-plugin/releases/tag/dsh-selfrepair-vv0.1.0
