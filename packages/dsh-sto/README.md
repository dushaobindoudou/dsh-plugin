...
[![npm](https://img.shields.io/npm/v/dsh-sto.svg)](https://www.npmjs.com/package/dsh-sto)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Sto - the security token offering** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The 2018 acronym that came back with actual liquidity - regulated issuance on-chain.
