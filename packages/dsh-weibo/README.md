...
[![npm](https://img.shields.io/npm/v/dsh-weibo.svg)](https://www.npmjs.com/package/dsh-weibo)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Weibo content toolkit for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Weibo content toolkit for dsh. (Recorded from the npm registry at import time.)
