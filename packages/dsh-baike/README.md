...
[![npm](https://img.shields.io/npm/v/dsh-baike.svg)](https://www.npmjs.com/package/dsh-baike)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Baike (百科) bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The Chinese encyclopedia lane - entry reads with citations, disambiguation handled, gaps flagged for drafting.
