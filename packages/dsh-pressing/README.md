...
[![npm](https://img.shields.io/npm/v/dsh-pressing.svg)](https://www.npmjs.com/package/dsh-pressing)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Pressing - the hunt without the ball** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Gegenpressing to low block - the defensive-style lane; PPDA measures the intensity.
