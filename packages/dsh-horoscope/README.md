...
[![npm](https://img.shields.io/npm/v/dsh-horoscope.svg)](https://www.npmjs.com/package/dsh-horoscope)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Horoscope for fun** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Horoscope for fun. (Recorded from the npm registry at import time.)
