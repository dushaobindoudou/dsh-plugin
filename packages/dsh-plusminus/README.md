...
[![npm](https://img.shields.io/npm/v/dsh-plusminus.svg)](https://www.npmjs.com/package/dsh-plusminus)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Plusminus - the team while you played** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Point differential on court - the impact lane; lineup data made it honest.
