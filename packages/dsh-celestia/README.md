...
[![npm](https://img.shields.io/npm/v/dsh-celestia.svg)](https://www.npmjs.com/package/dsh-celestia)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Celestia - the data availability layer** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Do not execute, just prove the data was there - modular blockchain thesis, part one.
