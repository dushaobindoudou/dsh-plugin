...
[![npm](https://img.shields.io/npm/v/dsh-hedge.svg)](https://www.npmjs.com/package/dsh-hedge)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Hedge - the other side of the trade** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Pay a little to not lose a lot - the risk-neutral lane; every good system has one.
