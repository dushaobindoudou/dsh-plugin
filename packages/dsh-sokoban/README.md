...
[![npm](https://img.shields.io/npm/v/dsh-sokoban.svg)](https://www.npmjs.com/package/dsh-sokoban)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Sokoban lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The box-pushing classic - deadlock detection, pull-reachability explained, level packs ranked by difficulty; a canonical planning benchmark.
