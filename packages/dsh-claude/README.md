...
[![npm](https://img.shields.io/npm/v/dsh-claude.svg)](https://www.npmjs.com/package/dsh-claude)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Anthropic Claude provider bridge for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Registers Claude models as dsh providers through the LLM adapter seam - extended thinking streamed as reasoning chunks, prompt-caching savings reported per turn.
