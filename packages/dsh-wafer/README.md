...
[![npm](https://img.shields.io/npm/v/dsh-wafer.svg)](https://www.npmjs.com/package/dsh-wafer)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Wafer - a disk of futures** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The three-hundred-millimeter disk that becomes a thousand chips - the batch lane; yield is destiny.
