...
[![npm](https://img.shields.io/npm/v/dsh-mistral.svg)](https://www.npmjs.com/package/dsh-mistral)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Mistral provider bridge for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Mistral and Codestral models as dsh providers - Codestral preconfigured for edit-heavy workflows.
