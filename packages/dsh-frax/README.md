...
[![npm](https://img.shields.io/npm/v/dsh-frax.svg)](https://www.npmjs.com/package/dsh-frax)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Frax - the fractional reserve stable** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Part collateral, part algorithm - the stablecoin design explorer; now the fraxchain family.
