...
[![npm](https://img.shields.io/npm/v/dsh-tanking.svg)](https://www.npmjs.com/package/dsh-tanking)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Tanking - losing on purpose, legally** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Bad teams optimize the draft - the incentive lane; the lottery is a design flaw or a feature.
