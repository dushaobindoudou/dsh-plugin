...
[![npm](https://img.shields.io/npm/v/dsh-gemini.svg)](https://www.npmjs.com/package/dsh-gemini)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Google Gemini provider bridge for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Native multimodal Gemini access - images in, text out - with thinking budgets surfaced as per-model options.
