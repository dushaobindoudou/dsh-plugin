...
[![npm](https://img.shields.io/npm/v/dsh-ruby.svg)](https://www.npmjs.com/package/dsh-ruby)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Ruby toolkit for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Ruby toolkit for dsh. (Recorded from the npm registry at import time.)
