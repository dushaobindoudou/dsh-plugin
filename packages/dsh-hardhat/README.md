...
[![npm](https://img.shields.io/npm/v/dsh-hardhat.svg)](https://www.npmjs.com/package/dsh-hardhat)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Hardhat bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Contract work in agent sessions - compile, test, and deploy flows over Hardhat with gas reports attached.
