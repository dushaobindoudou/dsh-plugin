...
[![npm](https://img.shields.io/npm/v/dsh-maoyan.svg)](https://www.npmjs.com/package/dsh-maoyan)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Maoyan bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Movie-time reads - showtimes, seat maps, and release digests; booking stays a human action.
