...
[![npm](https://img.shields.io/npm/v/dsh-pal.svg)](https://www.npmjs.com/package/dsh-pal)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Pal lane for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The shortest friend word - a companion that remembers yesterday, notices streaks, and asks about the thing you abandoned.
