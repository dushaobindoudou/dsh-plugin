...
[![npm](https://img.shields.io/npm/v/dsh-chengyu.svg)](https://www.npmjs.com/package/dsh-chengyu)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Chengyu lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The four-character classics - solitaire by last character, riddle-by-story, and usage examples cited to real texts.
