...
[![npm](https://img.shields.io/npm/v/dsh-lander.svg)](https://www.npmjs.com/package/dsh-lander)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Lander - seven minutes of terror** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

From orbit to surface on rockets and parachutes - the EDL lane; the hardest fifteen minutes.
