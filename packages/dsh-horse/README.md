...
[![npm](https://img.shields.io/npm/v/dsh-horse.svg)](https://www.npmjs.com/package/dsh-horse)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Horse - the galloping zodiac** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

午马 - a thousand li a day; every dsh-bole needs one - the speed form of the zodiac wall.
