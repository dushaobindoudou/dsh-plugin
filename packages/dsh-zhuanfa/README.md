...
[![npm](https://img.shields.io/npm/v/dsh-zhuanfa.svg)](https://www.npmjs.com/package/dsh-zhuanfa)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Zhuanfa - the repost** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

转发 - the share that moves information across the whole graph; the amplification lane.
