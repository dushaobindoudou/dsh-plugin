...
[![npm](https://img.shields.io/npm/v/dsh-sound.svg)](https://www.npmjs.com/package/dsh-sound)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Sound design for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Subtle completion and approval-ready chimes - off by default, tasteful when on.
