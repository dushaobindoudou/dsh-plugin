...
[![npm](https://img.shields.io/npm/v/dsh-silicon.svg)](https://www.npmjs.com/package/dsh-silicon)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Silicon - the actual sand** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The substrate of everything digital - the hardware lane; the pet lives on glass, the glass lives on sand.
