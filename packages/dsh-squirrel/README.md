...
[![npm](https://img.shields.io/npm/v/dsh-squirrel.svg)](https://www.npmjs.com/package/dsh-squirrel)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Squirrel - the acorn archivist** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Buries acorns and remembers where - exactly what dsh-tape does with your sessions; the archive mascot.
