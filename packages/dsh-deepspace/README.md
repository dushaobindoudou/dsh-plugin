...
[![npm](https://img.shields.io/npm/v/dsh-deepspace.svg)](https://www.npmjs.com/package/dsh-deepspace)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Deepspace - beyond the noise floor** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The Deep Space Network listens to spacecraft billions of kilometers out - the interplanetary lane.
