...
[![npm](https://img.shields.io/npm/v/dsh-bch.svg)](https://www.npmjs.com/package/dsh-bch)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Bch - the cash fork** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Bitcoin cash - the 2017 fork that argued blocks should be bigger; the schism lane, preserved.
