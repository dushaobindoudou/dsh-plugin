...
[![npm](https://img.shields.io/npm/v/dsh-newgame.svg)](https://www.npmjs.com/package/dsh-newgame)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Newgame - the blank save** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The title screen waits politely - a fresh session with none of the shame; everyone starts somewhere.
