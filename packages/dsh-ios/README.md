...
[![npm](https://img.shields.io/npm/v/dsh-ios.svg)](https://www.npmjs.com/package/dsh-ios)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**iOS developer role preset** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The Apple-platform specialist - Swift conventions, interface-guideline reflexes, and App Store release hygiene.
