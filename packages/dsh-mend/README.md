...
[![npm](https://img.shields.io/npm/v/dsh-mend.svg)](https://www.npmjs.com/package/dsh-mend)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Mend - the careful fix** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

To mend is to stitch what tore - the gentle sibling of dsh-heal, for fixes that patch without replacing.
