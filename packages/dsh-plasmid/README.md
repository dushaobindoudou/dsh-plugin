...
[![npm](https://img.shields.io/npm/v/dsh-plasmid.svg)](https://www.npmjs.com/package/dsh-plasmid)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Plasmid - the delivery vehicle** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Circular DNA that bacteria share - the cloning lane; the workhorse vector of molecular biology.
