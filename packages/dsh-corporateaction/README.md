...
[![npm](https://img.shields.io/npm/v/dsh-corporateaction.svg)](https://www.npmjs.com/package/dsh-corporateaction)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Corporateaction - splits on schedule** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Splits, dividends, mergers - the operations lane every real market runs on; now event-driven code.
