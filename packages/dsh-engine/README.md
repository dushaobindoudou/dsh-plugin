...
[![npm](https://img.shields.io/npm/v/dsh-engine.svg)](https://www.npmjs.com/package/dsh-engine)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The dsh engine seat** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The motor of the stack - the loop, the tools, and the state machine that turns a prompt into work; every lane in this catalog is a part it can wear.
