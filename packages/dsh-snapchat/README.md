...
[![npm](https://img.shields.io/npm/v/dsh-snapchat.svg)](https://www.npmjs.com/package/dsh-snapchat)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Snapchat channel bridge for dsh bots** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Spotlight digests and streak updates - short visual summaries composed from run summaries, sent after approval.
