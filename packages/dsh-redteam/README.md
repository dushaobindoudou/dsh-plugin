...
[![npm](https://img.shields.io/npm/v/dsh-redteam.svg)](https://www.npmjs.com/package/dsh-redteam)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Redteam - attack your own house** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Hired attackers with a license - the offense lane; break it before they do.
