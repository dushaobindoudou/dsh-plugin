...
[![npm](https://img.shields.io/npm/v/dsh-csdn.svg)](https://www.npmjs.com/package/dsh-csdn)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**CSDN bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The oldest dev portal - blog reads, search with citations, and the answer archives every Chinese dev has used.
