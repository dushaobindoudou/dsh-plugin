...
[![npm](https://img.shields.io/npm/v/dsh-sixsigma.svg)](https://www.npmjs.com/package/dsh-sixsigma)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Sixsigma - 3.4 defects per million** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The quality religion of Motorola and GE - measure everything, reduce variance; the SPC lane.
