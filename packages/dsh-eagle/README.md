...
[![npm](https://img.shields.io/npm/v/dsh-eagle.svg)](https://www.npmjs.com/package/dsh-eagle)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Eagle - the sharp-eyed form** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Eyes that never miss - the watcher form for dsh-radar sweeps; sees the stuck task from very high up.
