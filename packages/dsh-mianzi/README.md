...
[![npm](https://img.shields.io/npm/v/dsh-mianzi.svg)](https://www.npmjs.com/package/dsh-mianzi)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Mianzi - the face you keep** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

面子 - give it, save it, never make someone lose it; the etiquette engine every Chinese social product obeys.
