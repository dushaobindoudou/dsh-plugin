...
[![npm](https://img.shields.io/npm/v/dsh-lut.svg)](https://www.npmjs.com/package/dsh-lut)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Lut - the color transform table** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Look-up tables carry looks between systems - the color-pipeline lane; kin to dsh-colorgrading.
