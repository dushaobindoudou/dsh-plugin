...
[![npm](https://img.shields.io/npm/v/dsh-wagmi.svg)](https://www.npmjs.com/package/dsh-wagmi)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Wagmi-facing bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

React hooks become agent calls - wallet connection state and contract reads surfaced to sessions.
