...
[![npm](https://img.shields.io/npm/v/dsh-huarongdao.svg)](https://www.npmjs.com/package/dsh-huarongdao)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Huarongdao - slide Cao Cao out** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

华容道 - slide the blocks to free the trapped warlord; the sliding-block puzzle Chinese children keep by the bed.
