...
[![npm](https://img.shields.io/npm/v/dsh-fractional.svg)](https://www.npmjs.com/package/dsh-fractional)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Fractional - own one thousandth of Apple** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Split any share into any number of tokens - the access lane; the minimum ticket drops to a cent.
