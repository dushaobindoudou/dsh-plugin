...
[![npm](https://img.shields.io/npm/v/dsh-boardgame.svg)](https://www.npmjs.com/package/dsh-boardgame)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Boardgame - the plain category** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The generic seat: search boardgame, find the whole wall - chess to catan to werewolf.
