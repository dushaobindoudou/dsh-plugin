...
[![npm](https://img.shields.io/npm/v/dsh-meditate.svg)](https://www.npmjs.com/package/dsh-meditate)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Meditation companion for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Meditation companion for dsh. (Recorded from the npm registry at import time.)
