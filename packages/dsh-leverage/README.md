...
[![npm](https://img.shields.io/npm/v/dsh-leverage.svg)](https://www.npmjs.com/package/dsh-leverage)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Leverage - the multiplier** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Five x, fifty x - the amplification lane; the reason liquidation engines exist.
