...
[![npm](https://img.shields.io/npm/v/dsh-bom.svg)](https://www.npmjs.com/package/dsh-bom)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Bom - the bill of materials** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Every product is a list of parts - the composition lane; your stack has one too.
