...
[![npm](https://img.shields.io/npm/v/dsh-floorplan.svg)](https://www.npmjs.com/package/dsh-floorplan)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Floorplan - rooms before walls** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Place the blocks before routing the wires - the planning lane of chip design; architecture in the literal sense.
