...
[![npm](https://img.shields.io/npm/v/dsh-raydium.svg)](https://www.npmjs.com/package/dsh-raydium)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Raydium - the AMM with an orderbook** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Solana AMM plugged into central-limit books - hybrid liquidity, the OG solana dex.
