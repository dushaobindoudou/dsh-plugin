...
[![npm](https://img.shields.io/npm/v/dsh-foley.svg)](https://www.npmjs.com/package/dsh-foley)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Foley - footsteps recorded after** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Named for Jack Foley - the sound-effects lane; the world needs to crunch again.
