...
[![npm](https://img.shields.io/npm/v/dsh-holiday.svg)](https://www.npmjs.com/package/dsh-holiday)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Holiday planning for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Holiday planning for dsh. (Recorded from the npm registry at import time.)
