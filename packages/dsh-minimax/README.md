...
[![npm](https://img.shields.io/npm/v/dsh-minimax.svg)](https://www.npmjs.com/package/dsh-minimax)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**MiniMax provider bridge for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

MiniMax models as dsh providers through the same adapter seam the other bridges use.
