...
[![npm](https://img.shields.io/npm/v/dsh-gaode.svg)](https://www.npmjs.com/package/dsh-gaode)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The alternate spelling of the Amap bridge** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Compatibility name: the map bridge ships as dsh-amap; this form keeps the Chinese pinyin spelling installable.
