...
[![npm](https://img.shields.io/npm/v/dsh-siliconflow.svg)](https://www.npmjs.com/package/dsh-siliconflow)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**SiliconFlow provider bridge for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Aggregated open-model serving on SiliconFlow as dsh providers - one key, the whole Chinese open-model catalog.
