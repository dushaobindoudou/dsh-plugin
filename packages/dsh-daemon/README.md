...
[![npm](https://img.shields.io/npm/v/dsh-daemon.svg)](https://www.npmjs.com/package/dsh-daemon)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Background daemon for dsh bots** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

A launchd/systemd-friendly supervisor that keeps scheduled bots alive - starts on boot, restarts on crash, fronts the dsh-bot health socket.
