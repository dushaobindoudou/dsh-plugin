...
[![npm](https://img.shields.io/npm/v/dsh-emacs.svg)](https://www.npmjs.com/package/dsh-emacs)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Emacs bridge** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Run dsh from Emacs - region as context, org-mode integration for run notes; the old-school seam, M-x dsh.
