...
[![npm](https://img.shields.io/npm/v/dsh-ticker.svg)](https://www.npmjs.com/package/dsh-ticker)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Live ticker widgets for the dsh web GUI** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Live ticker widgets for the dsh web GUI. (Recorded from the npm registry at import time.)
