...
[![npm](https://img.shields.io/npm/v/dsh-rummy.svg)](https://www.npmjs.com/package/dsh-rummy)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Rummy lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Meld-making with commentary - the agent explains the deadwood math on every discard.
