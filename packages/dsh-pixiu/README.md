...
[![npm](https://img.shields.io/npm/v/dsh-pixiu.svg)](https://www.npmjs.com/package/dsh-pixiu)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Pixiu - the wealth guardian** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

貔貅 - takes in everything and never lets it out; the exact correct mascot for cost tracking and token ledgers.
