...
[![npm](https://img.shields.io/npm/v/dsh-futures.svg)](https://www.npmjs.com/package/dsh-futures)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Futures analytics for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Futures analytics for dsh. (Recorded from the npm registry at import time.)
