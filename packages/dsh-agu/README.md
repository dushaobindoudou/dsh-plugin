...
[![npm](https://img.shields.io/npm/v/dsh-agu.svg)](https://www.npmjs.com/package/dsh-agu)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Agu - A-shares, in Chinese** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

A股 - the mainland board with its own rhythm; the pinyin seat that completes the trio with dsh-meigu and dsh-ganggu.
