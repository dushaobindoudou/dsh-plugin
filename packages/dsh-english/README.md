...
[![npm](https://img.shields.io/npm/v/dsh-english.svg)](https://www.npmjs.com/package/dsh-english)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**English learning toolkit for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

English learning toolkit for dsh. (Recorded from the npm registry at import time.)
