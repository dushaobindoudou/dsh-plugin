...
[![npm](https://img.shields.io/npm/v/dsh-config.svg)](https://www.npmjs.com/package/dsh-config)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Config toolkit for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Config toolkit for dsh. (Recorded from the npm registry at import time.)
