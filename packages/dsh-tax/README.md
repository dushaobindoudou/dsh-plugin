...
[![npm](https://img.shields.io/npm/v/dsh-tax.svg)](https://www.npmjs.com/package/dsh-tax)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Tax research tools for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Tax research tools for dsh. (Recorded from the npm registry at import time.)
