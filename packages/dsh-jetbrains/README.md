...
[![npm](https://img.shields.io/npm/v/dsh-jetbrains.svg)](https://www.npmjs.com/package/dsh-jetbrains)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**JetBrains IDE bridge** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Run dsh from IntelliJ, PyCharm, WebStorm, and friends - project-aware context, diffs applied in the editor gutter.
