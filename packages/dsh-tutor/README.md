...
**Tutoring mode for dsh sessions** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Tutoring mode for dsh sessions. (Recorded from the npm registry at import time.)
