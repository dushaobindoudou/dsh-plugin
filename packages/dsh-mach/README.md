...
[![npm](https://img.shields.io/npm/v/dsh-mach.svg)](https://www.npmjs.com/package/dsh-mach)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Mach - the speed of sound as a ruler** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

One mach and the rules change - the aerodynamics lane; transonic drag, sonic booms.
