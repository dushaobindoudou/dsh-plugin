...
[![npm](https://img.shields.io/npm/v/dsh-freeagent.svg)](https://www.npmjs.com/package/dsh-freeagent)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Freeagent - the open market** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Contracts and cap space - the roster-construction lane; July first, the timeline melts.
