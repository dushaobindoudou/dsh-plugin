...
[![npm](https://img.shields.io/npm/v/dsh-notes.svg)](https://www.npmjs.com/package/dsh-notes)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Durable notes the agent can see** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

A persistent scratchpad exposed as a model-facing tool and a sidebar panel - what the agent writes survives compaction and session switches.
