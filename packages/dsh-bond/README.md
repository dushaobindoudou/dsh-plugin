...
[![npm](https://img.shields.io/npm/v/dsh-bond.svg)](https://www.npmjs.com/package/dsh-bond)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Bond lane for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The relationship state - trust levels that only real collaboration raises, decay that only real absence causes, saved as a portable file.
