...
[![npm](https://img.shields.io/npm/v/dsh-mes.svg)](https://www.npmjs.com/package/dsh-mes)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The MES bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Manufacturing-execution reads - production states, work orders (dsh-gongdan), and the shop-floor digest per shift.
