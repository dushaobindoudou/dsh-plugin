...
[![npm](https://img.shields.io/npm/v/dsh-hanabi.svg)](https://www.npmjs.com/package/dsh-hanabi)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Hanabi - the fireworks you cannot see** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

You hold your cards backwards and must be told what they are - the cooperative game about trust and information given imperfectly.
