...
[![npm](https://img.shields.io/npm/v/dsh-dictionary.svg)](https://www.npmjs.com/package/dsh-dictionary)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The spelled-out dictionary form** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The spelled-out dictionary form. (Recorded from the npm registry at import time.)
