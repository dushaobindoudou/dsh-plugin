...
[![npm](https://img.shields.io/npm/v/dsh-tiktok.svg)](https://www.npmjs.com/package/dsh-tiktok)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**TikTok channel bridge for dsh bots** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Publish run outputs as TikTok drafts - scripts, captions, and hashtags composed from runs.jsonl, approved before posting; the short-video outbound lane.
