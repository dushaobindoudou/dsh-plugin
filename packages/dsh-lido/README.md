...
[![npm](https://img.shields.io/npm/v/dsh-lido.svg)](https://www.npmjs.com/package/dsh-lido)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Lido - the liquid stake** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

stETH made staking liquid - the dominant validator lane; the liquidity that changed consensus economics.
