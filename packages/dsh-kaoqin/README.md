...
[![npm](https://img.shields.io/npm/v/dsh-kaoqin.svg)](https://www.npmjs.com/package/dsh-kaoqin)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Kaoqin (考勤) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Attendance reads - anomalies flagged with context, overtime math for payroll (dsh-gongzi), and the monthly sheet that closes itself.
