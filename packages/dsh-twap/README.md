...
[![npm](https://img.shields.io/npm/v/dsh-twap.svg)](https://www.npmjs.com/package/dsh-twap)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Twap - time-weighted patience** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Slice the order across the day - execution that does not move the market; also how migrations should run.
