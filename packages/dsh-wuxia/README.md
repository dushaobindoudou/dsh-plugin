...
[![npm](https://img.shields.io/npm/v/dsh-wuxia.svg)](https://www.npmjs.com/package/dsh-wuxia)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Wuxia (武侠) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The martial world as a genre - fight choreography drafting, sect politics, and hero arcs at serial pace; the companion to dsh-npc.
