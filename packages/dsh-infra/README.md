...
[![npm](https://img.shields.io/npm/v/dsh-infra.svg)](https://www.npmjs.com/package/dsh-infra)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Infrastructure inventory for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Infrastructure inventory for dsh. (Recorded from the npm registry at import time.)
