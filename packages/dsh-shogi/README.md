...
[![npm](https://img.shields.io/npm/v/dsh-shogi.svg)](https://www.npmjs.com/package/dsh-shogi)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Shogi partner for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Japanese chess - drops make it wild; the agent explains piece reuse and keeps the board state human-readable.
