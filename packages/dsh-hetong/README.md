...
[![npm](https://img.shields.io/npm/v/dsh-hetong.svg)](https://www.npmjs.com/package/dsh-hetong)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Hetong (合同) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Contract lifecycle in Chinese - clause reads, renewal watches, and the countersign state every deal waits on; the pinyin seat beside dsh-contract.
