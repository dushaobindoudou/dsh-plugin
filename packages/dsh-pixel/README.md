...
[![npm](https://img.shields.io/npm/v/dsh-pixel.svg)](https://www.npmjs.com/package/dsh-pixel)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Pixel-art lane for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Retro aesthetics as a first-class choice - palettes, dithering, and the 8-bit look that ages better than any glossy UI.
