...
[![npm](https://img.shields.io/npm/v/dsh-halt.svg)](https://www.npmjs.com/package/dsh-halt)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Halt - the trading stop** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

News pending, volatility spike, trading paused - the market-integrity lane; even chains need brakes.
