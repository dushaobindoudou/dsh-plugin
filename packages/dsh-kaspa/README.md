...
[![npm](https://img.shields.io/npm/v/dsh-kaspa.svg)](https://www.npmjs.com/package/dsh-kaspa)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Kaspa - the blockdag** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

GHOSTDAG protocol - parallel blocks, honest mining; kin to dsh-kas.
