...
[![npm](https://img.shields.io/npm/v/dsh-bird.svg)](https://www.npmjs.com/package/dsh-bird)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Bird - the sky lane form** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The general bird seat - kin to dsh-xique the magpie and dsh-qingniao the messenger; lands when news arrives.
