...
[![npm](https://img.shields.io/npm/v/dsh-selfheal.svg)](https://www.npmjs.com/package/dsh-selfheal)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Self-healing loop for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).
