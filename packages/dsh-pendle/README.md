...
[![npm](https://img.shields.io/npm/v/dsh-pendle.svg)](https://www.npmjs.com/package/dsh-pendle)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Pendle - yield, split and traded** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Principal and yield as separate tokens - the rate-market lane; fixed versus floating.
