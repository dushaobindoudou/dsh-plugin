...
[![npm](https://img.shields.io/npm/v/dsh-dengmi.svg)](https://www.npmjs.com/package/dsh-dengmi)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Dengmi - the lantern riddle** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

灯谜 - riddles hung on Lantern Festival lanterns; solve before the candle burns down.
