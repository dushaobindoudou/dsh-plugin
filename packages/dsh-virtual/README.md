...
[![npm](https://img.shields.io/npm/v/dsh-virtual.svg)](https://www.npmjs.com/package/dsh-virtual)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Virtual - the agent launchpad** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Virtuals protocol - co-owned AI agents on base; every agent an IP, every IP a token.
