...
[![npm](https://img.shields.io/npm/v/dsh-mahjong.svg)](https://www.npmjs.com/package/dsh-mahjong)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Mahjong table for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The four-seat classic - tile reads, discard logic, and a patient teacher mode for learners.
