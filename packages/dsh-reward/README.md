...
[![npm](https://img.shields.io/npm/v/dsh-reward.svg)](https://www.npmjs.com/package/dsh-reward)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Reward toolkit for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The signal the loop learns from - outcome scoring, rubric grading, and reward curves logged per run.
