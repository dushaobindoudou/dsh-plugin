...
[![npm](https://img.shields.io/npm/v/dsh-apogee.svg)](https://www.npmjs.com/package/dsh-apogee)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Apogee - the top of the arc** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The highest point of an orbit - the orbital-elements lane; burn at apogee to raise perigee.
