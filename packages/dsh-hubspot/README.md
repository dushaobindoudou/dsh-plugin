...
[![npm](https://img.shields.io/npm/v/dsh-hubspot.svg)](https://www.npmjs.com/package/dsh-hubspot)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**HubSpot bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The CRM as agent surface - contact research, deal-stage digests, and drafted follow-ups, every write approved before it lands.
