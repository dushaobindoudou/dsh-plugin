...
[![npm](https://img.shields.io/npm/v/dsh-manga.svg)](https://www.npmjs.com/package/dsh-manga)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Manga lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Panel drafts and storyboards - scripts broken into pages, prompts written per panel, style kept consistent.
