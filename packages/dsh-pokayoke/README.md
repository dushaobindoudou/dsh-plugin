...
[![npm](https://img.shields.io/npm/v/dsh-pokayoke.svg)](https://www.npmjs.com/package/dsh-pokayoke)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Pokayoke - mistake-proof it** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Design the error out instead of warning about it - the guardrail lane; a good linter is pokayoke.
