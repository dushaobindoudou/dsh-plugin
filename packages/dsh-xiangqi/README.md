...
[![npm](https://img.shields.io/npm/v/dsh-xiangqi.svg)](https://www.npmjs.com/package/dsh-xiangqi)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Xiangqi partner for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Chinese chess - openings explained, mid-game tactics annotated, endgames played out.
