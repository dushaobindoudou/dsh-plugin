...
[![npm](https://img.shields.io/npm/v/dsh-calc.svg)](https://www.npmjs.com/package/dsh-calc)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The short form of the calculator tools** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The short form of the calculator tools. (Recorded from the npm registry at import time.)
