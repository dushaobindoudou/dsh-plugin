...
[![npm](https://img.shields.io/npm/v/dsh-zhuanzhang.svg)](https://www.npmjs.com/package/dsh-zhuanzhang)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Zhuanzhang (转账) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The transfer ritual - drafts with confirmation context, receipts filed to runs.jsonl; every send human-approved.
