...
[![npm](https://img.shields.io/npm/v/dsh-headless.svg)](https://www.npmjs.com/package/dsh-headless)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Headless mode toolkit** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The no-GUI invocation contract - profile setup, prompt capture, and exit-code discipline for headless dsh runs; the layer dsh-bot spawns through.
