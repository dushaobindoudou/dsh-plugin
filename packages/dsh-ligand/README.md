...
[![npm](https://img.shields.io/npm/v/dsh-ligand.svg)](https://www.npmjs.com/package/dsh-ligand)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Ligand - the key for the lock** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The molecule that binds a receptor - the drug-discovery lane; kin to dsh-protein.
