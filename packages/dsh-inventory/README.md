...
[![npm](https://img.shields.io/npm/v/dsh-inventory.svg)](https://www.npmjs.com/package/dsh-inventory)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Inventory - the backpack** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Twelve slots and everything matters - what the pet carries: skins, abilities, mementos from finished quests.
