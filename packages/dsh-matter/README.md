...
[![npm](https://img.shields.io/npm/v/dsh-matter.svg)](https://www.npmjs.com/package/dsh-matter)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Matter bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The interoperability standard - certified devices discovered and controlled behind one fabric, scenes drafted for approval.
