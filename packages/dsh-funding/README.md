...
[![npm](https://img.shields.io/npm/v/dsh-funding.svg)](https://www.npmjs.com/package/dsh-funding)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Funding - the rate that keeps perps honest** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Perp price drifts from spot, funding rebalances it - the perpetuals lane; paid every hour.
