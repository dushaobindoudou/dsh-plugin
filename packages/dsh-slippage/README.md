...
[![npm](https://img.shields.io/npm/v/dsh-slippage.svg)](https://www.npmjs.com/package/dsh-slippage)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Slippage - the price drift** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The gap between the price you saw and the price you got - every swap pays it, every trader tracks it.
