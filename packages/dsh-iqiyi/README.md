...
[![npm](https://img.shields.io/npm/v/dsh-iqiyi.svg)](https://www.npmjs.com/package/dsh-iqiyi)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**iQiyi bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Watchlist reads and release alerts - the video lane of the daily-life stack.
