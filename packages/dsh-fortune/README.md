...
[![npm](https://img.shields.io/npm/v/dsh-fortune.svg)](https://www.npmjs.com/package/dsh-fortune)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Fortune lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Daily draws with a wink - tarot (dsh-tarot), lucky numbers, and Qian fortune sticks; entertainment-grade randomness, clearly labeled as such.
