...
[![npm](https://img.shields.io/npm/v/dsh-tuikuan.svg)](https://www.npmjs.com/package/dsh-tuikuan)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Tuikuan (退款) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The refund ritual - status tracking, reason drafting, and the escalation timeline every shopper dreads.
