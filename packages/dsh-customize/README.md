...
[![npm](https://img.shields.io/npm/v/dsh-customize.svg)](https://www.npmjs.com/package/dsh-customize)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Customization toolkit for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Everything adjustable - personas, tools, and guardrails edited as plain config with a diff and a rollback; no rebuild required.
