...
[![npm](https://img.shields.io/npm/v/dsh-serve.svg)](https://www.npmjs.com/package/dsh-serve)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Serve-mode extras for the dsh web GUI** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Auth, TLS, and shareable URLs for the web GUI on a LAN - one flag, safe defaults.
