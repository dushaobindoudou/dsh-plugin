...
[![npm](https://img.shields.io/npm/v/dsh-tiaoyitiao.svg)](https://www.npmjs.com/package/dsh-tiaoyitiao)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Tiaoyitiao - the jump that swept China** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

跳一跳 - hold, release, land on the next block; the WeChat minigame that taught a nation the spring scale.
