...
[![npm](https://img.shields.io/npm/v/dsh-elisa.svg)](https://www.npmjs.com/package/dsh-elisa)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Elisa - antibodies on a plate** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Enzyme-linked immunosorbent assay - the immunoassay lane; pregnancy tests to drug development.
