...
[![npm](https://img.shields.io/npm/v/dsh-baidu.svg)](https://www.npmjs.com/package/dsh-baidu)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Baidu bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The default Chinese search lane - web reads with citations, maps context via dsh-amap, and hot-list digests.
