...
[![npm](https://img.shields.io/npm/v/dsh-takt.svg)](https://www.npmjs.com/package/dsh-takt)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Takt - the heartbeat of the line** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

German for baton - production paced to demand; the rhythm lane; also how release trains tick.
