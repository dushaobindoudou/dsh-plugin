...
[![npm](https://img.shields.io/npm/v/dsh-trello.svg)](https://www.npmjs.com/package/dsh-trello)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Trello bridge for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Trello bridge for dsh. (Recorded from the npm registry at import time.)
