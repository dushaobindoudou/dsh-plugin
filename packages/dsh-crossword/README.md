...
[![npm](https://img.shields.io/npm/v/dsh-crossword.svg)](https://www.npmjs.com/package/dsh-crossword)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Crossword workshop for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Grid generation and clue drafting - themes chosen, clues ranked by difficulty, your solving time recorded.
