...
[![npm](https://img.shields.io/npm/v/dsh-lagrange.svg)](https://www.npmjs.com/package/dsh-lagrange)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Lagrange - the parking lots of space** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Five points where gravity balances - JWST lives at L2; the libration lane.
