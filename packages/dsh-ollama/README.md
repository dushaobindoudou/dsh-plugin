...
[![npm](https://img.shields.io/npm/v/dsh-ollama.svg)](https://www.npmjs.com/package/dsh-ollama)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Local-model provider bridge for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Registers Ollama-served models as dsh providers through the LLM adapter seam, auto-discovers installed models, and surfaces context-length limits in the model chip.
