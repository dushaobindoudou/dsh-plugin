...
[![npm](https://img.shields.io/npm/v/dsh-step.svg)](https://www.npmjs.com/package/dsh-step)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**StepFun model bridge** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

StepFun Step models as dsh providers - Chinese-market strength with per-turn pricing.
