...
[![npm](https://img.shields.io/npm/v/dsh-nav.svg)](https://www.npmjs.com/package/dsh-nav)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Nav - the price of the basket** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Net asset value, computed per block - the pricing lane for tokenized funds and ETFs.
