...
[![npm](https://img.shields.io/npm/v/dsh-starship.svg)](https://www.npmjs.com/package/dsh-starship)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Starship - the giant that catches itself** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Stainless steel, full reuse, chopsticks - the super-heavy lane; Mars is the stated destination.
