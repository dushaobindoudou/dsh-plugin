...
[![npm](https://img.shields.io/npm/v/dsh-vechain.svg)](https://www.npmjs.com/package/dsh-vechain)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Vechain - the supply chain chain** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

RFID to ledger - enterprise provenance from Shanghai; ToolChain and VeVote.
