...
[![npm](https://img.shields.io/npm/v/dsh-checkpoint.svg)](https://www.npmjs.com/package/dsh-checkpoint)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Checkpointing for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Save points with meaning - state snapshots before risky steps, restore points after failures, branching from any checkpoint.
