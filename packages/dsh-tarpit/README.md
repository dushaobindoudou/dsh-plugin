...
[![npm](https://img.shields.io/npm/v/dsh-tarpit.svg)](https://www.npmjs.com/package/dsh-tarpit)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Tarpit - slow the attacker down** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Answer every connection, painfully slowly - the exhaustion lane; patience for attackers is the scarce resource.
