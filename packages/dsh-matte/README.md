...
[![npm](https://img.shields.io/npm/v/dsh-matte.svg)](https://www.npmjs.com/package/dsh-matte)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Matte - the mask that shapes** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Hand-painted skies to digital masks - the compositing lane; everything layered needs one.
