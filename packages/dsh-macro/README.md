...
[![npm](https://img.shields.io/npm/v/dsh-macro.svg)](https://www.npmjs.com/package/dsh-macro)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Macro recorder for agent actions** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Record a sequence of agent actions once, replay it as one command with parameters - macros are prompt-level functions.
