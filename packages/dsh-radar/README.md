...
[![npm](https://img.shields.io/npm/v/dsh-radar.svg)](https://www.npmjs.com/package/dsh-radar)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Radar - the approval radar for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Nothing waits unseen - pending approvals, blocked questions, and stuck runs swept continuously and surfaced on the companion before you forget.
