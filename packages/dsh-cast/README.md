...
[![npm](https://img.shields.io/npm/v/dsh-cast.svg)](https://www.npmjs.com/package/dsh-cast)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Cast sessions to nearby screens** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

One-click presentation of a live session to a TV, projector, or second browser - read-only, zero-setup casting over the LAN.
