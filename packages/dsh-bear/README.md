...
[![npm](https://img.shields.io/npm/v/dsh-bear.svg)](https://www.npmjs.com/package/dsh-bear)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Bear - the sleepy strong form** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Naps through idle hours, carries entire build pipelines when awake; hibernates in the night lane with dsh-yutu.
