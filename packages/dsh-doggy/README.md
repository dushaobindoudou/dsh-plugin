...
[![npm](https://img.shields.io/npm/v/dsh-doggy.svg)](https://www.npmjs.com/package/dsh-doggy)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Doggy - the playful form** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The playful register of the loyal form - tail always going, fetches your tasks like sticks.
