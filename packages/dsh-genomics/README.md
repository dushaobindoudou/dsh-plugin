...
[![npm](https://img.shields.io/npm/v/dsh-genomics.svg)](https://www.npmjs.com/package/dsh-genomics)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Genomics - biology at scale** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Sequencing became a data industry - the omics lane; every sample is a dataset.
