...
[![npm](https://img.shields.io/npm/v/dsh-tplus1.svg)](https://www.npmjs.com/package/dsh-tplus1)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Tplus1 - wall street standard, crypto relic** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The US settlement upgrade of 2024 - and the baseline that tokenization makes obsolete.
