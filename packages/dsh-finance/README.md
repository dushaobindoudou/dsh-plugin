...
[![npm](https://img.shields.io/npm/v/dsh-finance.svg)](https://www.npmjs.com/package/dsh-finance)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Finance workspace for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Finance workspace for the DeepSeek Harness. (Recorded from the npm registry at import time.)
