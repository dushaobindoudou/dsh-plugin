...
[![npm](https://img.shields.io/npm/v/dsh-whitelist.svg)](https://www.npmjs.com/package/dsh-whitelist)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Whitelist - the guest list** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Allowed addresses only - the transfer-restriction lane; security tokens ship with one.
