...
[![npm](https://img.shields.io/npm/v/dsh-tikitaka.svg)](https://www.npmjs.com/package/dsh-tikitaka)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Tikitaka - the passing carousel** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Short passes, constant motion - the style lane; Barca made geometry beautiful.
