...
[![npm](https://img.shields.io/npm/v/dsh-isin.svg)](https://www.npmjs.com/package/dsh-isin)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Isin - the international serial** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Twelve characters that name every security on earth - the identifier lane; tokens need them too.
