...
[![npm](https://img.shields.io/npm/v/dsh-manta.svg)](https://www.npmjs.com/package/dsh-manta)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Manta - the privacy L2** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

zk applications with compliance hooks - the private-but-lawful lane.
