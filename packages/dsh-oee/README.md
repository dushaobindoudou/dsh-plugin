...
[![npm](https://img.shields.io/npm/v/dsh-oee.svg)](https://www.npmjs.com/package/dsh-oee)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Oee - overall equipment effectiveness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Availability times performance times quality - the one number a factory lives by; uptime for the physical world.
