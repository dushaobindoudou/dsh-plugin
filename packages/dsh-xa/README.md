...
[![npm](https://img.shields.io/npm/v/dsh-xa.svg)](https://www.npmjs.com/package/dsh-xa)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Xa - expected assists** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The pass before the xG - the chance-creation lane; kin to dsh-xg.
