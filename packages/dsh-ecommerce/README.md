...
[![npm](https://img.shields.io/npm/v/dsh-ecommerce.svg)](https://www.npmjs.com/package/dsh-ecommerce)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**E-commerce toolkit for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

E-commerce toolkit for dsh. (Recorded from the npm registry at import time.)
