...
[![npm](https://img.shields.io/npm/v/dsh-linear.svg)](https://www.npmjs.com/package/dsh-linear)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Linear bridge for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Linear bridge for dsh. (Recorded from the npm registry at import time.)
