...
[![npm](https://img.shields.io/npm/v/dsh-airdrop.svg)](https://www.npmjs.com/package/dsh-airdrop)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Airdrop - tokens from the sky** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Free tokens landing in wallets - the growth-hack lane; also how a pet could deliver rewards.
