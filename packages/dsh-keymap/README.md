...
[![npm](https://img.shields.io/npm/v/dsh-keymap.svg)](https://www.npmjs.com/package/dsh-keymap)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Keyboard shortcut manager for the dsh web GUI** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Custom chords, vim-mode presets, and importable keymaps for the DeepSeek Harness web UI.
