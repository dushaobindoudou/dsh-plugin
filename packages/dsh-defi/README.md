...
[![npm](https://img.shields.io/npm/v/dsh-defi.svg)](https://www.npmjs.com/package/dsh-defi)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**DeFi analytics for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

DeFi analytics for dsh. (Recorded from the npm registry at import time.)
