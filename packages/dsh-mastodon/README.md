...
[![npm](https://img.shields.io/npm/v/dsh-mastodon.svg)](https://www.npmjs.com/package/dsh-mastodon)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Mastodon channel bridge for dsh bots** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Fediverse presence for bots - instance-aware posting, content warnings set, replies triaged per instance rules.
