...
[![npm](https://img.shields.io/npm/v/dsh-restaking.svg)](https://www.npmjs.com/package/dsh-restaking)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Restaking - stake it twice** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Reuse the same stake to secure more networks - leverage made out of trust; compounding security.
