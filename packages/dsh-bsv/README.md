...
[![npm](https://img.shields.io/npm/v/dsh-bsv.svg)](https://www.npmjs.com/package/dsh-bsv)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Bsv - the other schism** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Bitcoin sv - the 2018 fork of the fork; the big-blocks-maximalist lane.
