...
[![npm](https://img.shields.io/npm/v/dsh-mascot.svg)](https://www.npmjs.com/package/dsh-mascot)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The mascot seat for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The flagship of the companion wall - a menubar creature that works with you: your bot skills behind a face, moods from real outcomes, screenshots that spread on their own.
