...
[![npm](https://img.shields.io/npm/v/dsh-raccoon.svg)](https://www.npmjs.com/package/dsh-raccoon)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Raccoon - the curious form** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Washes everything before using it, opens every latch - the form for agents that inspect and clean data.
