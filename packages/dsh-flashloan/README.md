...
[![npm](https://img.shields.io/npm/v/dsh-flashloan.svg)](https://www.npmjs.com/package/dsh-flashloan)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Flashloan - borrow and repay in one block** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Uncollateralized because atomic - the arbitrage lane that only exists on-chain; flash accounting for everything.
