...
[![npm](https://img.shields.io/npm/v/dsh-gongzi.svg)](https://www.npmjs.com/package/dsh-gongzi)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Gongzi (工资) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Payroll as a digest - gross-to-net math explained line by line, shebao (dsh-shebao) and gongjijin reconciled, payslips filed.
