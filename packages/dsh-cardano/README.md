...
[![npm](https://img.shields.io/npm/v/dsh-cardano.svg)](https://www.npmjs.com/package/dsh-cardano)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Cardano bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

UTXO-with-eUTXO reads - addresses, staking, and Plutus script context.
