...
[![npm](https://img.shields.io/npm/v/dsh-sharpe.svg)](https://www.npmjs.com/package/dsh-sharpe)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Sharpe - return per unit of pain** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The ratio that separates luck from skill - the performance-metric lane; agents get graded too.
