...
[![npm](https://img.shields.io/npm/v/dsh-applepay.svg)](https://www.npmjs.com/package/dsh-applepay)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Apple Pay-facing bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The Apple payment seam - merchant reads and payment-sheet drafts; credentials stay in the Secure Enclave, never in context.
