...
[![npm](https://img.shields.io/npm/v/dsh-securitytoken.svg)](https://www.npmjs.com/package/dsh-securitytoken)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Securitytoken - the regulated token** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

A token that admits it is a security - compliance-first design; the only lane institutions can buy.
