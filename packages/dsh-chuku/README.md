...
[![npm](https://img.shields.io/npm/v/dsh-chuku.svg)](https://www.npmjs.com/package/dsh-chuku)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Chuku (出库) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Outbound shipments - picks verified, orders reconciled, the fulfillment log every dispute resolves with.
