...
[![npm](https://img.shields.io/npm/v/dsh-dingdan.svg)](https://www.npmjs.com/package/dsh-dingdan)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Dingdan (订单) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Order reads across the commerce walls - status digests, exception flags, and the fulfillment chain (fahuo to tuikuan) traced.
