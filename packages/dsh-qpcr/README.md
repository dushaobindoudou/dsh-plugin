...
[![npm](https://img.shields.io/npm/v/dsh-qpcr.svg)](https://www.npmjs.com/package/dsh-qpcr)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Qpcr - quantify while you copy** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Real-time PCR with fluorescence - the quantification lane; the pandemic made it a household word.
