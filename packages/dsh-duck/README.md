...
[![npm](https://img.shields.io/npm/v/dsh-duck.svg)](https://www.npmjs.com/package/dsh-duck)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Duck - the calm surface form** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Calm above the water, paddling hard below - the truest portrait of a background agent you never see working.
