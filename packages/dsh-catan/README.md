...
[![npm](https://img.shields.io/npm/v/dsh-catan.svg)](https://www.npmjs.com/package/dsh-catan)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Catan - settle the island** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Trade wood for brick, build the longest road - the game that made trading with friends a negotiation mechanic; the modern-boardgame crown.
