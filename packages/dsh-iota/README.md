...
[![npm](https://img.shields.io/npm/v/dsh-iota.svg)](https://www.npmjs.com/package/dsh-iota)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Iota - the tangle** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

No blocks, no fees - the DAG ledger for machines; the IoT-payment lane.
