...
[![npm](https://img.shields.io/npm/v/dsh-capsule.svg)](https://www.npmjs.com/package/dsh-capsule)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Capsule - the ride home** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Crew Dragon to Orion - the crewed-vehicle lane; heat shields and parachutes, again.
