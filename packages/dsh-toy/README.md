...
[![npm](https://img.shields.io/npm/v/dsh-toy.svg)](https://www.npmjs.com/package/dsh-toy)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The toy seat for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Play that pays rent - small delightful interactions (pat, feed, poke) that carry real function underneath; the lane where utility and affection share a body.
