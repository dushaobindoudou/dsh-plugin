...
[![npm](https://img.shields.io/npm/v/dsh-respawn.svg)](https://www.npmjs.com/package/dsh-respawn)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Respawn - death is not the end** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

You died at the lava, you respawn at the shrine - crash recovery with grace; the self-repair lane of the games wall.
