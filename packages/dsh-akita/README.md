...
[![npm](https://img.shields.io/npm/v/dsh-akita.svg)](https://www.npmjs.com/package/dsh-akita)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Akita - the one who waits** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Hachiko - the breed that waited at the station every day; the natural form for long-task watching: it waits so you do not have to.
