...
[![npm](https://img.shields.io/npm/v/dsh-metrics.svg)](https://www.npmjs.com/package/dsh-metrics)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Token and latency metrics for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Per session, model, and provider - with daily budgets and a spend projection.
