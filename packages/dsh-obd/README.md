...
[![npm](https://img.shields.io/npm/v/dsh-obd.svg)](https://www.npmjs.com/package/dsh-obd)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Obd - the diagnostic port** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

On-board diagnostics - the socket that tells you why the light is on; every car has been an API since 1996.
