...
[![npm](https://img.shields.io/npm/v/dsh-alert.svg)](https://www.npmjs.com/package/dsh-alert)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Alerts for dsh sessions** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Webhooks, sound, or system notification when a session needs input or fails - walk away safely.
