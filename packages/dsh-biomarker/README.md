...
[![npm](https://img.shields.io/npm/v/dsh-biomarker.svg)](https://www.npmjs.com/package/dsh-biomarker)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Biomarker - the measurable signal** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

A molecule that says disease or response - the translational lane; endpoints need markers.
