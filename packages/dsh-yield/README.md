...
[![npm](https://img.shields.io/npm/v/dsh-yield.svg)](https://www.npmjs.com/package/dsh-yield)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Yield - the return stream** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Treasury yield, staking yield, funding yield - the income lane; on-chain is where yield got composability.
