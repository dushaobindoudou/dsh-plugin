...
[![npm](https://img.shields.io/npm/v/dsh-sessions.svg)](https://www.npmjs.com/package/dsh-sessions)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Session manager and browser** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

List, inspect, and resume past dsh sessions from terminal or GUI - filters by project, date, and outcome; the multi-session ops view.
