...
[![npm](https://img.shields.io/npm/v/dsh-fil.svg)](https://www.npmjs.com/package/dsh-fil)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Fil - the filecoin ticker** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Pay for storage in the native unit - the decentralized-storage lane; proofs of replication.
