...
[![npm](https://img.shields.io/npm/v/dsh-beacon.svg)](https://www.npmjs.com/package/dsh-beacon)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Beacon - the signal lane for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

One light per state - green done, amber waiting, red broken; the ambient status language for a desktop full of agents.
