...
[![npm](https://img.shields.io/npm/v/dsh-jixiao.svg)](https://www.npmjs.com/package/dsh-jixiao)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Jixiao (绩效) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Performance-review prep - goal tracking, evidence collected through the cycle, the self-review drafted, calibration data assembled.
