...
[![npm](https://img.shields.io/npm/v/dsh-chainlink.svg)](https://www.npmjs.com/package/dsh-chainlink)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Chainlink oracle bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Price feeds with proof context - every number the agent cites carries its oracle round.
