...
[![npm](https://img.shields.io/npm/v/dsh-scm.svg)](https://www.npmjs.com/package/dsh-scm)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The SCM bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Supply-chain planning reads - forecasts, lead times, and the disruption feed (dsh-gongyinglian) in one digest.
