...
[![npm](https://img.shields.io/npm/v/dsh-puzzle.svg)](https://www.npmjs.com/package/dsh-puzzle)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Puzzle corner for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Puzzle corner for dsh. (Recorded from the npm registry at import time.)
