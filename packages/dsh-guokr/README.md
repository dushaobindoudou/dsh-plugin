...
[![npm](https://img.shields.io/npm/v/dsh-guokr.svg)](https://www.npmjs.com/package/dsh-guokr)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Guokr (果壳) bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Popular-science reads - article digests and myth-busting cited to sources.
