...
[![npm](https://img.shields.io/npm/v/dsh-slate.svg)](https://www.npmjs.com/package/dsh-slate)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Slate - scene one, take one** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The clapboard that syncs it all - the production lane; smart slates carry timecode.
