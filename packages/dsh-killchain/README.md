...
[![npm](https://img.shields.io/npm/v/dsh-killchain.svg)](https://www.npmjs.com/package/dsh-killchain)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Killchain - the attacker checklist** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Recon to exfiltration, stage by stage - disrupt any link and the whole chain breaks; threat-model lane.
