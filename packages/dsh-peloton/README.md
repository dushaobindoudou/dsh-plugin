...
[![npm](https://img.shields.io/npm/v/dsh-peloton.svg)](https://www.npmjs.com/package/dsh-peloton)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Peloton bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Class reads and streak digests over the Peloton lane.
