...
[![npm](https://img.shields.io/npm/v/dsh-staking.svg)](https://www.npmjs.com/package/dsh-staking)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Staking - put tokens to work** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Lock value, secure the network, earn yield - the patient-capital lane of web3.
