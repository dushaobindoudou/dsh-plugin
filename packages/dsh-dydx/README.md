...
[![npm](https://img.shields.io/npm/v/dsh-dydx.svg)](https://www.npmjs.com/package/dsh-dydx)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Dydx - the perp exchange veteran** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Order-book perpetuals on-chain since the bear market - the derivatives-venue lane.
