...
[![npm](https://img.shields.io/npm/v/dsh-bittensor.svg)](https://www.npmjs.com/package/dsh-bittensor)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Bittensor - the neural internet** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Subnets competing to be useful - the decentralized-AI lane with real emissions.
