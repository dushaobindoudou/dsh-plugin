...
[![npm](https://img.shields.io/npm/v/dsh-designer.svg)](https://www.npmjs.com/package/dsh-designer)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Product designer role preset** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Interface judgment as a persona - hierarchy, typography, and flow critiques on the diffs a crew produces; pairs with dsh-ux.
