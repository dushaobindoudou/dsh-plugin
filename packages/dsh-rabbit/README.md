...
[![npm](https://img.shields.io/npm/v/dsh-rabbit.svg)](https://www.npmjs.com/package/dsh-rabbit)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Rabbit - the swift gentle form** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Kin to dsh-yutu the moon rabbit - fast, quiet, hard working through the night.
