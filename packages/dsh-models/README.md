...
[![npm](https://img.shields.io/npm/v/dsh-models.svg)](https://www.npmjs.com/package/dsh-models)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Model registry panel for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Every registered model in one table - context windows, pricing, thinking modes, and which provider serves it; pin defaults per profile.
