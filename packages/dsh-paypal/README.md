...
[![npm](https://img.shields.io/npm/v/dsh-paypal.svg)](https://www.npmjs.com/package/dsh-paypal)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**PayPal bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The consumer-payment lane - transaction reads, refund drafts with reason codes, and monthly statements summarized by the agent.
