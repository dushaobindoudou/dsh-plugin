...
[![npm](https://img.shields.io/npm/v/dsh-flappy.svg)](https://www.npmjs.com/package/dsh-flappy)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Flappy - the tap to fly** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

One tap, endless pipes - the hardest easy game ever made; the one-button lane.
