...
[![npm](https://img.shields.io/npm/v/dsh-neo.svg)](https://www.npmjs.com/package/dsh-neo)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Neo - the chinese ethereum** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The smart-economy chain from Shanghai - the original Chinese public chain; contracts in familiar languages.
