...
[![npm](https://img.shields.io/npm/v/dsh-rubric.svg)](https://www.npmjs.com/package/dsh-rubric)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Scoring rubrics for agent work** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Declarative rubric files - criteria, weights, pass thresholds - shared by dsh-judge and humans; the contract that makes evaluation reproducible.
