...
[![npm](https://img.shields.io/npm/v/dsh-ros.svg)](https://www.npmjs.com/package/dsh-ros)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**ROS bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The robot operating system wired to sessions - topics read, missions drafted, and the bag-file analysis every robotics team dreads, automated.
