...
[![npm](https://img.shields.io/npm/v/dsh-rollup.svg)](https://www.npmjs.com/package/dsh-rollup)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Rollup - batch it, prove it** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Execute off-chain, prove on-chain - the scaling thesis of the era; batch processing for blockspace.
