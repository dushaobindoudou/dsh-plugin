...
[![npm](https://img.shields.io/npm/v/dsh-cusip.svg)](https://www.npmjs.com/package/dsh-cusip)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Cusip - the American serial** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Nine characters that name every US security - the identifier lane; same idea, tighter scope.
