...
[![npm](https://img.shields.io/npm/v/dsh-kava.svg)](https://www.npmjs.com/package/dsh-kava)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Kava - the lending chain** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Cross-chain DeFi with its own chain - the collateralized-loans lane, cosmos native.
