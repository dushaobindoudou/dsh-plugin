...
[![npm](https://img.shields.io/npm/v/dsh-gpt.svg)](https://www.npmjs.com/package/dsh-gpt)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The GPT-family spelled form of the OpenAI bridge** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Compatibility name: the OpenAI bridge ships as dsh-openai; this form keeps the model-family spelling installable.
