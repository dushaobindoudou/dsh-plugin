...
[![npm](https://img.shields.io/npm/v/dsh-strands.svg)](https://www.npmjs.com/package/dsh-strands)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Strands - the letters web** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Drag through the grid until the theme reveals itself - the word-search lane, one thread at a time.
