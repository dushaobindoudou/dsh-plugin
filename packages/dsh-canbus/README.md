...
[![npm](https://img.shields.io/npm/v/dsh-canbus.svg)](https://www.npmjs.com/package/dsh-canbus)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Canbus - the car nervous system** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Controller area network - every sensor and actuator shouting on two wires; the vehicle lane.
