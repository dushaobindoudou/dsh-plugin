...
[![npm](https://img.shields.io/npm/v/dsh-doge.svg)](https://www.npmjs.com/package/dsh-doge)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The short form of the Dogecoin bridge** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Compatibility name: the Dogecoin bridge ships as dsh-dogecoin; this form keeps the ticker spelling installable.
