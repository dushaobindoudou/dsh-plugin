...
[![npm](https://img.shields.io/npm/v/dsh-sei.svg)](https://www.npmjs.com/package/dsh-sei)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Sei - the orderbook chain** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Built-in CLOB at chain speed - the trading-first L1; parallel execution.
