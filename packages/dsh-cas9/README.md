...
[![npm](https://img.shields.io/npm/v/dsh-cas9.svg)](https://www.npmjs.com/package/dsh-cas9)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Cas9 - the molecular scissors** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The protein that cuts where guided - kin to dsh-crispr; the workhorse nuclease.
