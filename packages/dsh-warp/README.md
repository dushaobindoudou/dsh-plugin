...
[![npm](https://img.shields.io/npm/v/dsh-warp.svg)](https://www.npmjs.com/package/dsh-warp)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Warp terminal bridge** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Run dsh inside Warp blocks - output captured per block, AI-native terminal meets agent-native harness.
