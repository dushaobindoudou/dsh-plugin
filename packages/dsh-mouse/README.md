...
[![npm](https://img.shields.io/npm/v/dsh-mouse.svg)](https://www.npmjs.com/package/dsh-mouse)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Mouse - the first zodiac** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

子鼠 - first of the twelve; finds paths through walls no one else fits through; zodiac skin slot one.
