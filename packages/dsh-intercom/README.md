...
[![npm](https://img.shields.io/npm/v/dsh-intercom.svg)](https://www.npmjs.com/package/dsh-intercom)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Intercom bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Support inbox as bot lane - conversations triaged, routine replies drafted in your voice, handoff notes for humans on hard tickets.
