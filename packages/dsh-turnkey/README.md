...
[![npm](https://img.shields.io/npm/v/dsh-turnkey.svg)](https://www.npmjs.com/package/dsh-turnkey)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Turnkey stacks for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

One install, whole outcome - curated toolchains that deliver a working result end to end, no assembly required.
