...
[![npm](https://img.shields.io/npm/v/dsh-zhiyin.svg)](https://www.npmjs.com/package/dsh-zhiyin)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Zhiyin (知音) - the friend who understands your music** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

From Boya and Ziqi - when the one listener who truly understood was gone, the qin was broken. A companion that knows which task matters to you is rarer than a thousand contacts.
