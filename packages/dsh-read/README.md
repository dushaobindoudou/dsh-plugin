...
[![npm](https://img.shields.io/npm/v/dsh-read.svg)](https://www.npmjs.com/package/dsh-read)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Reading mode for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Reading mode for dsh. (Recorded from the npm registry at import time.)
