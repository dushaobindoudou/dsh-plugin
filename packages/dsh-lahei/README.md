...
[![npm](https://img.shields.io/npm/v/dsh-lahei.svg)](https://www.npmjs.com/package/dsh-lahei)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Lahei (拉黑) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The block ritual - moderation rules that learn, harassers filtered at scale, and the audit log for every mute.
