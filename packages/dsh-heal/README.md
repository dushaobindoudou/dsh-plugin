...
[![npm](https://img.shields.io/npm/v/dsh-heal.svg)](https://www.npmjs.com/package/dsh-heal)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Heal - the four-letter fix** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The shortest word that means it got better - kin to dsh-doctor: diagnose first, heal second; the repair lane of the harness.
