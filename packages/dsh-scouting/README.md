...
[![npm](https://img.shields.io/npm/v/dsh-scouting.svg)](https://www.npmjs.com/package/dsh-scouting)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Scouting - the eye and the model** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Grades, reports, comps - the talent lane; the draft is the market where they meet.
