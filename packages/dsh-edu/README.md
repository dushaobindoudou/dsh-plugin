...
[![npm](https://img.shields.io/npm/v/dsh-edu.svg)](https://www.npmjs.com/package/dsh-edu)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Education workspace for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Education workspace for dsh. (Recorded from the npm registry at import time.)
