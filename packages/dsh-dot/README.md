...
[![npm](https://img.shields.io/npm/v/dsh-dot.svg)](https://www.npmjs.com/package/dsh-dot)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Dot - the polkadot ticker** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The ticker of the interoperability chain - kin to dsh-polkadot; parachains as shards of one relay.
