...
[![npm](https://img.shields.io/npm/v/dsh-levelup.svg)](https://www.npmjs.com/package/dsh-levelup)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Levelup - the moment it clicks** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Ding - new skill, bigger numbers; the growth lane that turns streak days and bond into visible rank.
