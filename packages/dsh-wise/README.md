...
[![npm](https://img.shields.io/npm/v/dsh-wise.svg)](https://www.npmjs.com/package/dsh-wise)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Wise bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Cross-border lane - FX quotes, transfer drafts, and rate alerts over the Wise API; the go-global money mover.
