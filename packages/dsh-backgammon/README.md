...
[![npm](https://img.shields.io/npm/v/dsh-backgammon.svg)](https://www.npmjs.com/package/dsh-backgammon)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Backgammon - the oldest race** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Five thousand years of dice and doubling - the game that taught the world risk management.
