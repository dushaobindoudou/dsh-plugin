...
[![npm](https://img.shields.io/npm/v/dsh-keying.svg)](https://www.npmjs.com/package/dsh-keying)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Keying - pulling the matte** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Extract foreground from background - kin to dsh-chroma; edge quality is the craft.
