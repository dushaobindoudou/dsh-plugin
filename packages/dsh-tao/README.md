...
[![npm](https://img.shields.io/npm/v/dsh-tao.svg)](https://www.npmjs.com/package/dsh-tao)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Tao - the bittensor unit** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

A market for machine intelligence - miners train, validators score; the AI-blockchain ticker.
