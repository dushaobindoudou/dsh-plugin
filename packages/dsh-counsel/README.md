...
[![npm](https://img.shields.io/npm/v/dsh-counsel.svg)](https://www.npmjs.com/package/dsh-counsel)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Counsel lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Research support for legal work - statutes and precedents located and cited, arguments drafted for a licensed lawyer to own.
