...
[![npm](https://img.shields.io/npm/v/dsh-peptide.svg)](https://www.npmjs.com/package/dsh-peptide)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Peptide - the short chain** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

A few amino acids with outsized effects - kin to dsh-protein; GLP-1 made peptides famous.
