...
[![npm](https://img.shields.io/npm/v/dsh-arbitrage.svg)](https://www.npmjs.com/package/dsh-arbitrage)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Arbitrage - the free lunch hunt** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Buy there, sell here, pocket the gap - the efficiency engine of markets; latency is the whole game.
