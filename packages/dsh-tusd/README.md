...
[![npm](https://img.shields.io/npm/v/dsh-tusd.svg)](https://www.npmjs.com/package/dsh-tusd)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Tusd - the true usd** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The transparent-reserve stablecoin - the off-chain-attestation lane.
