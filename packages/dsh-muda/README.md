...
[![npm](https://img.shields.io/npm/v/dsh-muda.svg)](https://www.npmjs.com/package/dsh-muda)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Muda - the seven wastes** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

無駄 - transport, inventory, motion, waiting, overproduction, overprocessing, defects - the deletion checklist; every backlog audit starts here.
