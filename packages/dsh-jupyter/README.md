...
[![npm](https://img.shields.io/npm/v/dsh-jupyter.svg)](https://www.npmjs.com/package/dsh-jupyter)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Jupyter bridge for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Jupyter bridge for dsh. (Recorded from the npm registry at import time.)
