...
[![npm](https://img.shields.io/npm/v/dsh-ethena.svg)](https://www.npmjs.com/package/dsh-ethena)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Ethena - the synthetic dollar factory** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The team behind USDe - cash-and-carry as a protocol; kin to dsh-basis.
