...
[![npm](https://img.shields.io/npm/v/dsh-suite.svg)](https://www.npmjs.com/package/dsh-suite)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The full suite installer** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Every plugin from this developer in one add - finder, git, diff, search, and the rest, pre-wired to agree with each other.
