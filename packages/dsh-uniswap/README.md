...
[![npm](https://img.shields.io/npm/v/dsh-uniswap.svg)](https://www.npmjs.com/package/dsh-uniswap)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Uniswap bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Pool reads, quote math, and route drafts - swaps composed by the agent, approved and signed by you.
