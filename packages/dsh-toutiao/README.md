...
[![npm](https://img.shields.io/npm/v/dsh-toutiao.svg)](https://www.npmjs.com/package/dsh-toutiao)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Toutiao bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The feed lane - trending digests and channel reads composed into morning briefings.
