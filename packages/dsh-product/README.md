...
[![npm](https://img.shields.io/npm/v/dsh-product.svg)](https://www.npmjs.com/package/dsh-product)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Product management tools for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Product management tools for dsh. (Recorded from the npm registry at import time.)
