...
[![npm](https://img.shields.io/npm/v/dsh-fireworks.svg)](https://www.npmjs.com/package/dsh-fireworks)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Fireworks AI provider bridge for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Fast open-model serving as dsh providers, Fireworks model IDs mapped to friendly names.
