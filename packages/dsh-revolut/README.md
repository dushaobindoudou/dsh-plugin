...
[![npm](https://img.shields.io/npm/v/dsh-revolut.svg)](https://www.npmjs.com/package/dsh-revolut)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Revolut bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The neobank lane - account reads and transfer drafts over the business API, FX included.
