...
[![npm](https://img.shields.io/npm/v/dsh-health.svg)](https://www.npmjs.com/package/dsh-health)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Live health status for dsh installs** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).
