...
[![npm](https://img.shields.io/npm/v/dsh-dtc.svg)](https://www.npmjs.com/package/dsh-dtc)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Dtc - the vault of wall street** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The Depository Trust Company holds most of the paper - the incumbent lane; on-chain is the new vault.
