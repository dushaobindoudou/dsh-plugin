...
[![npm](https://img.shields.io/npm/v/dsh-mempool.svg)](https://www.npmjs.com/package/dsh-mempool)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Mempool - the waiting room** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Where transactions wait to be mined - the queue lane; MEV hunts here and so do good block builders.
