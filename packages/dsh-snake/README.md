...
[![npm](https://img.shields.io/npm/v/dsh-snake.svg)](https://www.npmjs.com/package/dsh-snake)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Snake lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The classic rebuilt for benchmarks - grid world, hunger, and wall-death; the perfect toy task for agent evaluation.
