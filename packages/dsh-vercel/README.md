...
[![npm](https://img.shields.io/npm/v/dsh-vercel.svg)](https://www.npmjs.com/package/dsh-vercel)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Vercel bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Deploy previews as first-class artifacts - the agent proposes, the preview builds, you approve the promotion to production.
