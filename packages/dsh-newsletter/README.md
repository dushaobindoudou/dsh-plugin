...
[![npm](https://img.shields.io/npm/v/dsh-newsletter.svg)](https://www.npmjs.com/package/dsh-newsletter)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Newsletter toolkit for dsh bots** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The format itself as a channel - issue templates, digests from runs.jsonl, subscribe and unsubscribe handling, deliverability checks before send.
