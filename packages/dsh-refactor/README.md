...
[![npm](https://img.shields.io/npm/v/dsh-refactor.svg)](https://www.npmjs.com/package/dsh-refactor)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Refactor workflows for the dsh web GUI** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Symbol renames and moves previewed as one whole-change diff before anything writes - multi-file, reviewable, reversible.
