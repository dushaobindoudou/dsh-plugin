...
[![npm](https://img.shields.io/npm/v/dsh-threads.svg)](https://www.npmjs.com/package/dsh-threads)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Threads channel bridge for dsh bots** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Short-form posts to Threads - digest threads composed from runs.jsonl, cross-posted with dsh-instagram in one approval.
