...
[![npm](https://img.shields.io/npm/v/dsh-puppy.svg)](https://www.npmjs.com/package/dsh-puppy)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Puppy - the young dog stage** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The growth stage of the loyal form - overexcited, learns fast, celebrates every single tool call like the first.
