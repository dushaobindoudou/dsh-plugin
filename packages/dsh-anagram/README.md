...
[![npm](https://img.shields.io/npm/v/dsh-anagram.svg)](https://www.npmjs.com/package/dsh-anagram)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Anagram - the letters scramble** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Same letters, new word - the puzzle lane for finding the better name hiding inside the old one.
