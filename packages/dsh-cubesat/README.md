...
[![npm](https://img.shields.io/npm/v/dsh-cubesat.svg)](https://www.npmjs.com/package/dsh-cubesat)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Cubesat - space for everyone** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Ten-centimeter units, standardized - the smallsat lane; a university can fly a mission.
