...
[![npm](https://img.shields.io/npm/v/dsh-bingo.svg)](https://www.npmjs.com/package/dsh-bingo)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Bingo - the loud success** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Five in a row and you shout it - the celebration call when every check turns green.
