...
[![npm](https://img.shields.io/npm/v/dsh-folding.svg)](https://www.npmjs.com/package/dsh-folding)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Folding - the shape is the function** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The protein-folding problem - the computational-biology lane; solved enough to matter.
