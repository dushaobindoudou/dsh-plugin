...
[![npm](https://img.shields.io/npm/v/dsh-nanopore.svg)](https://www.npmjs.com/package/dsh-nanopore)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Nanopore - sequencing through a hole** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

DNA threading through a pore, base by base - the long-read lane; real-time, pocket-sized.
