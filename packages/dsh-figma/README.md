...
[![npm](https://img.shields.io/npm/v/dsh-figma.svg)](https://www.npmjs.com/package/dsh-figma)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Figma bridge for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Figma bridge for dsh. (Recorded from the npm registry at import time.)
