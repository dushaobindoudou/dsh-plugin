...
[![npm](https://img.shields.io/npm/v/dsh-groq.svg)](https://www.npmjs.com/package/dsh-groq)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Groq provider bridge for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

LPU-fast inference behind the standard seam - time-to-first-token shown live in the session header.
