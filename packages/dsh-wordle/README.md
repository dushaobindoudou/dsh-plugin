...
[![npm](https://img.shields.io/npm/v/dsh-wordle.svg)](https://www.npmjs.com/package/dsh-wordle)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Wordle solver for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Daily-puzzle lane - candidate filtering by feedback, letter-frequency priors, and a clean streak tracker.
