...
[![npm](https://img.shields.io/npm/v/dsh-rtl.svg)](https://www.npmjs.com/package/dsh-rtl)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Rtl - register transfer level** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The abstraction where chips are designed - clocked logic as text; the HDL lane.
