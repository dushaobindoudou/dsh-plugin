...
[![npm](https://img.shields.io/npm/v/dsh-closer.svg)](https://www.npmjs.com/package/dsh-closer)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The closer role for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The last-mile specialist - takes 90-percent-done work and drives it to merged, shipped, paid, or published.
