...
[![npm](https://img.shields.io/npm/v/dsh-slot.svg)](https://www.npmjs.com/package/dsh-slot)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Slot - the three reels** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

One lever, three reels - the spin lane for raffle-style rewards and random easter eggs.
