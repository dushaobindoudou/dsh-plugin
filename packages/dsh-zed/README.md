...
[![npm](https://img.shields.io/npm/v/dsh-zed.svg)](https://www.npmjs.com/package/dsh-zed)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Zed bridge for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Drive dsh agents from Zed over the Agent Client Protocol - the editor-native counterpart to the VS Code bridge.
