...
[![npm](https://img.shields.io/npm/v/dsh-doordash.svg)](https://www.npmjs.com/package/dsh-doordash)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**DoorDash bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The delivery lane - order status and ETA reads, driver-close nudges routed per dsh-dnd.
