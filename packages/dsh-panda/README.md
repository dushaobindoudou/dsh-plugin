...
[![npm](https://img.shields.io/npm/v/dsh-panda.svg)](https://www.npmjs.com/package/dsh-panda)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Panda - the national treasure form** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Eats, sleeps, adored by everyone - and secretly stronger than most; the chill form for idle moods.
