...
[![npm](https://img.shields.io/npm/v/dsh-dopesheet.svg)](https://www.npmjs.com/package/dsh-dopesheet)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Dopesheet - the animator spreadsheet** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Frame-by-frame exposure charts - the animation lane; from cel days, still in every DCC.
