...
[![npm](https://img.shields.io/npm/v/dsh-kepler.svg)](https://www.npmjs.com/package/dsh-kepler)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Kepler - the laws that govern orbits** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Ellipses, periods, harmony - the orbital-mechanics lane named for the first quantifier of the sky.
