...
[![npm](https://img.shields.io/npm/v/dsh-api3.svg)](https://www.npmjs.com/package/dsh-api3)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Api3 - first-party oracles** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

APIs pushed on-chain by their owners - the dAPI lane; kin to dsh-pyth.
