...
[![npm](https://img.shields.io/npm/v/dsh-hongbao.svg)](https://www.npmjs.com/package/dsh-hongbao)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Hongbao (红包) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The red-envelope ritual - send and receive digests, occasion templates, and the group-chat economy; the payment ceremony Alipay and WeChat orbit.
