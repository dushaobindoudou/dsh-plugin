...
[![npm](https://img.shields.io/npm/v/dsh-sidekick.svg)](https://www.npmjs.com/package/dsh-sidekick)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Sidekick seat for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The companion role named plainly - not an assistant you summon but a presence that stays, reacts, and occasionally saves the day.
