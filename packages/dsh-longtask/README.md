...
[![npm](https://img.shields.io/npm/v/dsh-longtask.svg)](https://www.npmjs.com/package/dsh-longtask)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Long-task toolkit for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The unit of long work - tasks that outlive sessions, split resumably, and merge their results.
