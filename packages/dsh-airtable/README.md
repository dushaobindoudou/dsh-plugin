...
[![npm](https://img.shields.io/npm/v/dsh-airtable.svg)](https://www.npmjs.com/package/dsh-airtable)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Airtable bridge for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Airtable bridge for dsh. (Recorded from the npm registry at import time.)
