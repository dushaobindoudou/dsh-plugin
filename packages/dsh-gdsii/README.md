...
[![npm](https://img.shields.io/npm/v/dsh-gdsii.svg)](https://www.npmjs.com/package/dsh-gdsii)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Gdsii - the layout format** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The binary geometry that fabs actually eat - the shipping format of silicon; polygons all the way down.
