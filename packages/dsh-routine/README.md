...
[![npm](https://img.shields.io/npm/v/dsh-routine.svg)](https://www.npmjs.com/package/dsh-routine)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Routine engine for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The rhythm of your day - morning briefs, standup digests, and shutdown rituals scheduled around your actual clock.
