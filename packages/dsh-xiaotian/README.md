...
[![npm](https://img.shields.io/npm/v/dsh-xiaotian.svg)](https://www.npmjs.com/package/dsh-xiaotian)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Xiaotian (哮天) - the howling celestial hound** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Erlang Shen is hound that never misses. The guardian lane - watch mode for long-running tasks, barking only when something needs you.
