...
[![npm](https://img.shields.io/npm/v/dsh-guoxue.svg)](https://www.npmjs.com/package/dsh-guoxue)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Guoxue (国学) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The Chinese classics - primary-text reads with translations, idiom origins (dsh-chengyu), and the canon explained.
