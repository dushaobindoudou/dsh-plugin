...
[![npm](https://img.shields.io/npm/v/dsh-parlay.svg)](https://www.npmjs.com/package/dsh-parlay)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Parlay - the correlated dream** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Multiple legs, one ticket - the betting lane; the house margin compounds.
