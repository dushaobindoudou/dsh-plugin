...
[![npm](https://img.shields.io/npm/v/dsh-dba.svg)](https://www.npmjs.com/package/dsh-dba)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Database administrator role preset** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Schema reviews, index strategy, and query plans - the DBA persona for crews touching data layers; the role behind the dsh-db tool surface.
