...
[![npm](https://img.shields.io/npm/v/dsh-stargate.svg)](https://www.npmjs.com/package/dsh-stargate)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Stargate - the unified bridge** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Transfer native assets across chains - the liquidity-transport lane on layerzero.
