...
[![npm](https://img.shields.io/npm/v/dsh-ronin.svg)](https://www.npmjs.com/package/dsh-ronin)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Ronin - the axie chain** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The gaming chain born from a phenomenon - the play-to-earn infrastructure lane.
