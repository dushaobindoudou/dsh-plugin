...
[![npm](https://img.shields.io/npm/v/dsh-baichuan.svg)](https://www.npmjs.com/package/dsh-baichuan)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Baichuan model bridge** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Baichuan models as dsh providers through the LLM adapter seam - Chinese-language strength, pricing surfaced per turn.
