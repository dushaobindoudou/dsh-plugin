...
[![npm](https://img.shields.io/npm/v/dsh-checkers.svg)](https://www.npmjs.com/package/dsh-checkers)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Checkers partner for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Draughts with commentary - forced jumps explained, endgame databases referenced, mistakes flagged kindly.
