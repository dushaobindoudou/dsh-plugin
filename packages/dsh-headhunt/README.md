...
[![npm](https://img.shields.io/npm/v/dsh-headhunt.svg)](https://www.npmjs.com/package/dsh-headhunt)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Headhunter workbench** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Outreach sequences, candidate pipelining, and engagement notes for agency recruiters - batch research on companies and roles, agent-drafted messages with human review.
