...
[![npm](https://img.shields.io/npm/v/dsh-greenscreen.svg)](https://www.npmjs.com/package/dsh-greenscreen)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Greenscreen - the void you replace** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Chroma key against green - the compositing lane; kin to dsh-chroma.
