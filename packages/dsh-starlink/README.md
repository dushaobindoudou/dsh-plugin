...
[![npm](https://img.shields.io/npm/v/dsh-starlink.svg)](https://www.npmjs.com/package/dsh-starlink)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Starlink - the internet from above** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Thousands of satellites, a dish on the roof - the direct-to-consumer space lane.
