...
[![npm](https://img.shields.io/npm/v/dsh-collateral.svg)](https://www.npmjs.com/package/dsh-collateral)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Collateral - the skin in the game** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Post it, borrow against it, get liquidated if it drops - the risk-engine lane; tokenized stocks are collateral now.
