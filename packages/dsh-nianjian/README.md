...
[![npm](https://img.shields.io/npm/v/dsh-nianjian.svg)](https://www.npmjs.com/package/dsh-nianjian)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Nianjian (年检) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The annual-inspection calendar - what renews when, evidence collected through the year, deadlines watched so nothing lapses.
