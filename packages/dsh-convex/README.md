...
[![npm](https://img.shields.io/npm/v/dsh-convex.svg)](https://www.npmjs.com/package/dsh-convex)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Convex - the curve booster** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Aggregated CRV voting power - the meta-protocol lane; protocols voting through protocols.
