...
[![npm](https://img.shields.io/npm/v/dsh-connections.svg)](https://www.npmjs.com/package/dsh-connections)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Connections - the hidden link** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Sixteen words, four secret groups - find why they belong together; the daily puzzle about categories.
