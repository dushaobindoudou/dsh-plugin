...
[![npm](https://img.shields.io/npm/v/dsh-siliao.svg)](https://www.npmjs.com/package/dsh-siliao)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Siliao - the private line** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

私聊 - one to one, off the record; the DM lane in Chinese.
