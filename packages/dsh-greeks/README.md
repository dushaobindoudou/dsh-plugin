...
[![npm](https://img.shields.io/npm/v/dsh-greeks.svg)](https://www.npmjs.com/package/dsh-greeks)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Greeks - the sensitivity alphabet** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Delta gamma vega theta rho - how an option feels every wiggle; the vocabulary of measured risk.
