...
[![npm](https://img.shields.io/npm/v/dsh-kimi.svg)](https://www.npmjs.com/package/dsh-kimi)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Kimi provider bridge for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Moonshot Kimi models as dsh providers - long-context variants surfaced with their true context windows.
