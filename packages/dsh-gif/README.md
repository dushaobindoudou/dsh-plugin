...
[![npm](https://img.shields.io/npm/v/dsh-gif.svg)](https://www.npmjs.com/package/dsh-gif)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**GIF lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Reaction GIFs on demand - search, caption, and cut; the agent speaks in GIFs when words are not enough.
