...
[![npm](https://img.shields.io/npm/v/dsh-kas.svg)](https://www.npmjs.com/package/dsh-kas)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Kas - the kaspa ticker** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

BlockDAG, one block per second and climbing - the PoW speedrun ticker.
