...
[![npm](https://img.shields.io/npm/v/dsh-anime.svg)](https://www.npmjs.com/package/dsh-anime)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Anime toolkit for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Anime toolkit for dsh. (Recorded from the npm registry at import time.)
