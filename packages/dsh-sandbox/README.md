...
[![npm](https://img.shields.io/npm/v/dsh-sandbox.svg)](https://www.npmjs.com/package/dsh-sandbox)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Sandboxed execution for agent commands** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Commands that must not touch the host run inside a seatbelt sandbox - filesystem and network policy enforced per invocation.
