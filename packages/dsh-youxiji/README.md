...
[![npm](https://img.shields.io/npm/v/dsh-youxiji.svg)](https://www.npmjs.com/package/dsh-youxiji)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Youxiji - the game console** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

游戏机 - the machine dedicated to play; the hardware-lane seat in pinyin.
