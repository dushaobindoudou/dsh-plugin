...
[![npm](https://img.shields.io/npm/v/dsh-liquidation.svg)](https://www.npmjs.com/package/dsh-liquidation)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Liquidation - the margin call** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

When collateral fails, positions close you - the forced-exit lane; the reason risk limits exist.
