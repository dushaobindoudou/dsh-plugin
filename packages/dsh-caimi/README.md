...
[![npm](https://img.shields.io/npm/v/dsh-caimi.svg)](https://www.npmjs.com/package/dsh-caimi)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Caimi - guess the riddle** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

猜谜 - the verb lane of the riddle wall: kin to dsh-riddle and dsh-miyu.
