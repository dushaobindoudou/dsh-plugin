...
[![npm](https://img.shields.io/npm/v/dsh-rooster.svg)](https://www.npmjs.com/package/dsh-rooster)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Rooster - the dawn reporter** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

酉鸡 - crows exactly when the day starts; the morning-report form: yesterday at a glance, on time, every day.
