...
[![npm](https://img.shields.io/npm/v/dsh-gift.svg)](https://www.npmjs.com/package/dsh-gift)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Gift planning for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Gift planning for dsh. (Recorded from the npm registry at import time.)
