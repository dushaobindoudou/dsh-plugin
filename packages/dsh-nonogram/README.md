...
[![npm](https://img.shields.io/npm/v/dsh-nonogram.svg)](https://www.npmjs.com/package/dsh-nonogram)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Nonogram - the picture in numbers** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Count the clues, fill the grid, watch a picture appear - the logic-art lane; sudoku with a gallery.
