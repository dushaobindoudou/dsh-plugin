...
[![npm](https://img.shields.io/npm/v/dsh-2048.svg)](https://www.npmjs.com/package/dsh-2048)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**2048 lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The merge classic - optimal-corner policy explained, board heuristics visible, high scores logged per run.
