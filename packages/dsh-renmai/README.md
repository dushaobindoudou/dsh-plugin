...
[![npm](https://img.shields.io/npm/v/dsh-renmai.svg)](https://www.npmjs.com/package/dsh-renmai)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Renmai - the network you grow** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

人脉 - your cultivated web of people; the professional-relationship lane, cousin of dsh-guanxi.
