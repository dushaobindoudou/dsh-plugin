...
[![npm](https://img.shields.io/npm/v/dsh-esports.svg)](https://www.npmjs.com/package/dsh-esports)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Esports toolkit for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Esports toolkit for dsh. (Recorded from the npm registry at import time.)
