...
[![npm](https://img.shields.io/npm/v/dsh-gala.svg)](https://www.npmjs.com/package/dsh-gala)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Gala - the games publisher on-chain** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Games to music to film - the entertainment-node lane.
