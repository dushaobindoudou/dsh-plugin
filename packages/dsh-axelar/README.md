...
[![npm](https://img.shields.io/npm/v/dsh-axelar.svg)](https://www.npmjs.com/package/dsh-axelar)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Axelar - the cross-chain router** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Proof-of-stake message routing - the general-message lane; stack-agnostic.
