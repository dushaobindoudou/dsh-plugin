...
[![npm](https://img.shields.io/npm/v/dsh-mode.svg)](https://www.npmjs.com/package/dsh-mode)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Mode - the op-stack for builders** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Revenue-sharing rollup - the op-stack economy lane.
