...
[![npm](https://img.shields.io/npm/v/dsh-router.svg)](https://www.npmjs.com/package/dsh-router)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Model router for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Per-task routing rules - cheap models draft, strong models finish - without editing profiles or restarting.
