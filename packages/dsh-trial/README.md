...
[![npm](https://img.shields.io/npm/v/dsh-trial.svg)](https://www.npmjs.com/package/dsh-trial)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Trial - the randomized truth machine** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Phases one to three - the clinical lane; the most expensive experiment in medicine.
