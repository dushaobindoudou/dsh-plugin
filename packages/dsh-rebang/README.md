...
[![npm](https://img.shields.io/npm/v/dsh-rebang.svg)](https://www.npmjs.com/package/dsh-rebang)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Rebang - the hot list** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

热榜 - the ranked board of what matters today; every Chinese content app has one.
