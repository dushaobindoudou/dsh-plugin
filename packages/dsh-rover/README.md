...
[![npm](https://img.shields.io/npm/v/dsh-rover.svg)](https://www.npmjs.com/package/dsh-rover)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Rover - the wheels on another world** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Sojourner to Perseverance - the planetary-surface lane; autonomy because light-delay forbids joysticks.
