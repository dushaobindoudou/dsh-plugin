...
[![npm](https://img.shields.io/npm/v/dsh-loot.svg)](https://www.npmjs.com/package/dsh-loot)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Loot - the reward table** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The fun part of every fight - loot rarity tiers map one to one to task rewards and easter eggs.
