...
[![npm](https://img.shields.io/npm/v/dsh-ocean.svg)](https://www.npmjs.com/package/dsh-ocean)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Ocean - the data marketplace** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Tokenize datasets and models - the data-DeFi lane; merged into the ASI alliance.
