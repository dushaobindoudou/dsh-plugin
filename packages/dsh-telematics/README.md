...
[![npm](https://img.shields.io/npm/v/dsh-telematics.svg)](https://www.npmjs.com/package/dsh-telematics)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Telematics - the car that phones home** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

GPS plus cellular plus the CAN bus - fleet intelligence; the mobility-data lane.
