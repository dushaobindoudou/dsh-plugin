...
[![npm](https://img.shields.io/npm/v/dsh-qilin.svg)](https://www.npmjs.com/package/dsh-qilin)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Qilin - the auspicious supreme form** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

麒麟 - appears only at great moments; the rarest skin, shown when a milestone lands.
