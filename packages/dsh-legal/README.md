...
[![npm](https://img.shields.io/npm/v/dsh-legal.svg)](https://www.npmjs.com/package/dsh-legal)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The spelled-out legal workspace form** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The spelled-out legal workspace form. (Recorded from the npm registry at import time.)
