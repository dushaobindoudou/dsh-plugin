...
[![npm](https://img.shields.io/npm/v/dsh-basis.svg)](https://www.npmjs.com/package/dsh-basis)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Basis - the futures spot gap** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Cash and carry, the oldest trade - the spread lane; funding rates made it a public scoreboard.
