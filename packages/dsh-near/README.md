...
[![npm](https://img.shields.io/npm/v/dsh-near.svg)](https://www.npmjs.com/package/dsh-near)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**NEAR bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Sharded-chain reads - account state, access keys, and receipts in agent context.
