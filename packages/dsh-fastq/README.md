...
[![npm](https://img.shields.io/npm/v/dsh-fastq.svg)](https://www.npmjs.com/package/dsh-fastq)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Fastq - the raw text of life** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Four lines per read - the bioinformatics lane; the file format where computation begins.
