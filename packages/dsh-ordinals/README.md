...
[![npm](https://img.shields.io/npm/v/dsh-ordinals.svg)](https://www.npmjs.com/package/dsh-ordinals)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Ordinals - satoshis with serials** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Number every satoshi and inscribe art on the tiniest units - the bitcoin-collectibles lane.
