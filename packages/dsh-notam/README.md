...
[![npm](https://img.shields.io/npm/v/dsh-notam.svg)](https://www.npmjs.com/package/dsh-notam)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Notam - the pilot bulletin** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Notice to air missions - runway closed, lights out, crane up; the operational-safety lane.
