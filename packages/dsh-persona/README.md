...
[![npm](https://img.shields.io/npm/v/dsh-persona.svg)](https://www.npmjs.com/package/dsh-persona)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Persona marketplace for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Install, switch, and pin agent personas (dsh-persona rows) from the GUI, with a community listing and per-profile overrides.
