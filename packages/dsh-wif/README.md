...
[![npm](https://img.shields.io/npm/v/dsh-wif.svg)](https://www.npmjs.com/package/dsh-wif)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Wif - the dog in the hat** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Dogwifhat - the purest vibe asset on solana; the beanie is the brand.
