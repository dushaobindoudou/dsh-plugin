...
[![npm](https://img.shields.io/npm/v/dsh-rebirth.svg)](https://www.npmjs.com/package/dsh-rebirth)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Rebirth - the new game plus** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Finish the run, keep the growth, start the loop again - reincarnation for agents; the prestige lane of the long horizon.
