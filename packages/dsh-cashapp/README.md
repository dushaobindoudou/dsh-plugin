...
[![npm](https://img.shields.io/npm/v/dsh-cashapp.svg)](https://www.npmjs.com/package/dsh-cashapp)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Cash App bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The P2P lane - payment reads and request drafts over the Cash App API.
