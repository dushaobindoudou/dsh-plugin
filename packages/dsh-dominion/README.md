...
[![npm](https://img.shields.io/npm/v/dsh-dominion.svg)](https://www.npmjs.com/package/dsh-dominion)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Dominion - build the deck** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Your deck IS your strategy - the game that founded deckbuilding; every card you buy today draws tomorrow.
