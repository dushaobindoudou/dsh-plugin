...
[![npm](https://img.shields.io/npm/v/dsh-bedrock.svg)](https://www.npmjs.com/package/dsh-bedrock)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**AWS Bedrock provider bridge for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

IAM-authenticated model access - no static API keys in settings.yaml, roles assumed through the ambient credential chain.
