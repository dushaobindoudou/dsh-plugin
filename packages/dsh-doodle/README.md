...
[![npm](https://img.shields.io/npm/v/dsh-doodle.svg)](https://www.npmjs.com/package/dsh-doodle)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Doodle - the draw and guess** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

You draw badly, they guess wildly - the drawing lane, kin to dsh-drawguess.
