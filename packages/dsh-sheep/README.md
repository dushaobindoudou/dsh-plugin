...
[![npm](https://img.shields.io/npm/v/dsh-sheep.svg)](https://www.npmjs.com/package/dsh-sheep)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Sheep - the gentle zodiac** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

未羊 - soft wool, warm company; the kindness seat of the zodiac wall.
