...
[![npm](https://img.shields.io/npm/v/dsh-xp.svg)](https://www.npmjs.com/package/dsh-xp)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Xp - the experience bar** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Points that only go up when you do the thing - the same rule as dsh-bond: real work fills the bar, clicks do not.
