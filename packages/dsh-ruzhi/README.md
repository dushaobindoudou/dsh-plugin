...
[![npm](https://img.shields.io/npm/v/dsh-ruzhi.svg)](https://www.npmjs.com/package/dsh-ruzhi)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Ruzhi (入职) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Onboarding as a checklist - equipment, accounts, training calendared, the first-week plan every new hire deserves.
