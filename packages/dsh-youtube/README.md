...
[![npm](https://img.shields.io/npm/v/dsh-youtube.svg)](https://www.npmjs.com/package/dsh-youtube)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**YouTube channel bridge for dsh bots** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Turn session replays into YouTube drafts - title, description, chapters, and thumbnail drafted by the agent, uploaded after approval.
