...
[![npm](https://img.shields.io/npm/v/dsh-trading.svg)](https://www.npmjs.com/package/dsh-trading)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Trading lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Market work with a hard edge - reads, alerts, and journal entries; orders exist only as drafts the human signs. Registered externally; promoted into the curated core.
