...
[![npm](https://img.shields.io/npm/v/dsh-matic.svg)](https://www.npmjs.com/package/dsh-matic)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Matic - the original polygon name** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The 2017 name that became a chain of chains - kin to dsh-pol and dsh-polygon.
