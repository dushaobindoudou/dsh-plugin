...
[![npm](https://img.shields.io/npm/v/dsh-secrets.svg)](https://www.npmjs.com/package/dsh-secrets)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Secrets handling for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Reference credentials by name, never paste values into prompts - agent sees the reference, never the key.
