...
[![npm](https://img.shields.io/npm/v/dsh-aevo.svg)](https://www.npmjs.com/package/dsh-aevo)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Aevo - options on-chain** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Options and perps on a custom rollup - the derivatives lane with a tapeout soul.
