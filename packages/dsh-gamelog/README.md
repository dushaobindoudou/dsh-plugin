...
[![npm](https://img.shields.io/npm/v/dsh-gamelog.svg)](https://www.npmjs.com/package/dsh-gamelog)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Gamelog - one row per game** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The longitudinal record - the player-history lane; streaks and slumps hide in it.
