...
[![npm](https://img.shields.io/npm/v/dsh-xiansuo.svg)](https://www.npmjs.com/package/dsh-xiansuo)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Xiansuo (线索) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Lead management - sources tracked, duplicates merged, enrichment drafted, and the handoff to opportunity scored.
