...
[![npm](https://img.shields.io/npm/v/dsh-zigbee.svg)](https://www.npmjs.com/package/dsh-zigbee)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Zigbee bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The mesh behind smart homes - device inventory, state reads, and scene drafts for the coordinator you own.
