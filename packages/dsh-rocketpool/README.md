...
[![npm](https://img.shields.io/npm/v/dsh-rocketpool.svg)](https://www.npmjs.com/package/dsh-rocketpool)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Rocketpool - the decentralized staker** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Node operator marketplace - the censorship-resistant lane of liquid staking.
