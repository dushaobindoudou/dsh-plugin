...
[![npm](https://img.shields.io/npm/v/dsh-dog.svg)](https://www.npmjs.com/package/dsh-dog)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Dog - the loyal form** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The other classic - greets you every time you return, thrilled about finished tasks, never judges the failed ones.
