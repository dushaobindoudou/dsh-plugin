...
[![npm](https://img.shields.io/npm/v/dsh-youku.svg)](https://www.npmjs.com/package/dsh-youku)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Youku bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Watchlist digests and new-episode alerts over the Youku lane.
