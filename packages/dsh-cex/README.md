...
[![npm](https://img.shields.io/npm/v/dsh-cex.svg)](https://www.npmjs.com/package/dsh-cex)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**CEX toolkit for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The generic exchange seat - one interface over exchange APIs (read balances, draft orders) while brand names sit elsewhere; keys stay in the OS keychain.
