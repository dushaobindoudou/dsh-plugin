...
[![npm](https://img.shields.io/npm/v/dsh-equities.svg)](https://www.npmjs.com/package/dsh-equities)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Equities - ownership as a token** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

A share is a claim; a token is a claim that moves at software speed - the on-chain stock lane.
