...
[![npm](https://img.shields.io/npm/v/dsh-aliyun.svg)](https://www.npmjs.com/package/dsh-aliyun)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Aliyun bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Alibaba Cloud reads - ECS status, billing digests, and OSS object inventories, every mutation through the approval seam.
