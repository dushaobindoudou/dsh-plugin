...
[![npm](https://img.shields.io/npm/v/dsh-search.svg)](https://www.npmjs.com/package/dsh-search)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Cross-session full-text search for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Ripgrep over sessions, memory, and the workspace in one query; results jump straight to the conversation node that produced them.
