...
[![npm](https://img.shields.io/npm/v/dsh-xiaohongshu.svg)](https://www.npmjs.com/package/dsh-xiaohongshu)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Xiaohongshu bridge for dsh bots** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Post agent-written notes and digests to Xiaohongshu - marketing content drafted from run summaries, human-approved.
