...
[![npm](https://img.shields.io/npm/v/dsh-journal.svg)](https://www.npmjs.com/package/dsh-journal)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Journal lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The daily debrief - prompts, mood ticks, and highlights; entries written by you, summarized by the agent, kept private by policy. Registered externally; promoted into the curated core.
