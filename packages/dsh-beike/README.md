...
[![npm](https://img.shields.io/npm/v/dsh-beike.svg)](https://www.npmjs.com/package/dsh-beike)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Beike bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The housing lane - listing reads, price-per-square-meter comps, and neighborhood research digests.
