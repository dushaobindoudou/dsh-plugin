...
[![npm](https://img.shields.io/npm/v/dsh-placebo.svg)](https://www.npmjs.com/package/dsh-placebo)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Placebo - the control arm** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The pill that treats belief - the clinical-trials lane; honest comparisons require it.
