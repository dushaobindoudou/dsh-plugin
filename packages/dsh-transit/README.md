...
[![npm](https://img.shields.io/npm/v/dsh-transit.svg)](https://www.npmjs.com/package/dsh-transit)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Transit toolkit for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Transit toolkit for dsh. (Recorded from the npm registry at import time.)
