...
[![npm](https://img.shields.io/npm/v/dsh-oneshot.svg)](https://www.npmjs.com/package/dsh-oneshot)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**One-shot execution for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The single-pass ideal - get it right the first time, with the checklist that makes one-shot actually land.
