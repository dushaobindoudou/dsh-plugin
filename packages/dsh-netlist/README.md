...
[![npm](https://img.shields.io/npm/v/dsh-netlist.svg)](https://www.npmjs.com/package/dsh-netlist)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Netlist - the wiring truth** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Every gate and every wire in a flat list - the compiled output of hardware; ground truth after synthesis.
