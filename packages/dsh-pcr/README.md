...
[![npm](https://img.shields.io/npm/v/dsh-pcr.svg)](https://www.npmjs.com/package/dsh-pcr)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Pcr - a billion copies from one** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The polymerase chain reaction - the amplification lane; the technique that made molecular biology scalable.
