...
[![npm](https://img.shields.io/npm/v/dsh-broker.svg)](https://www.npmjs.com/package/dsh-broker)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Task broker for agent fleets** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

A matchmaking layer between queued work and idle bots - capability tags, load, and affinity in one routing decision.
