...
[![npm](https://img.shields.io/npm/v/dsh-lighter.svg)](https://www.npmjs.com/package/dsh-lighter)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Lighter - the zero-fee perp book** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Order-book perps with gasless execution - the zk-rollup venue lane.
