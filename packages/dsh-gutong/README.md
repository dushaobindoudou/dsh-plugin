...
[![npm](https://img.shields.io/npm/v/dsh-gutong.svg)](https://www.npmjs.com/package/dsh-gutong)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Gutong - the connect programs** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

股通 - shanghai and shenzhen stock connect - the corridor lane; northbound and southbound flow.
