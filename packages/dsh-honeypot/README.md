...
[![npm](https://img.shields.io/npm/v/dsh-honeypot.svg)](https://www.npmjs.com/package/dsh-honeypot)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Honeypot - the trap that looks tasty** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

A fake target full of alarms - the deception lane; anyone who touches it has already told you everything.
