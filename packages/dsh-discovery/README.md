...
[![npm](https://img.shields.io/npm/v/dsh-discovery.svg)](https://www.npmjs.com/package/dsh-discovery)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Discovery engine for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Serendipity on purpose - explorations scheduled beyond your taste (dsh-taste) with an escape hatch always visible.
