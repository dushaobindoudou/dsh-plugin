...
[![npm](https://img.shields.io/npm/v/dsh-klotski.svg)](https://www.npmjs.com/package/dsh-klotski)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Klotski - the sliding block** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The international name of the sliding-block family - kin to dsh-huarongdao; fifteen puzzle cousins.
