...
[![npm](https://img.shields.io/npm/v/dsh-clean.svg)](https://www.npmjs.com/package/dsh-clean)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Safe-clean the dsh home** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Caches, spill files, stale backups - a preview of exactly what goes, then it goes.
