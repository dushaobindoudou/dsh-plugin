...
[![npm](https://img.shields.io/npm/v/dsh-lending.svg)](https://www.npmjs.com/package/dsh-lending)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Lending - the money market** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Supply, borrow, earn - the compound-and-aave lane; now with tokenized treasuries as collateral.
