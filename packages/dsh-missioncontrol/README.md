...
[![npm](https://img.shields.io/npm/v/dsh-missioncontrol.svg)](https://www.npmjs.com/package/dsh-missioncontrol)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Missioncontrol - the room that flies the mission** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Consoles, callouts, go-no-go - the flight-operations lane; calm voices, checklists, redundancy.
