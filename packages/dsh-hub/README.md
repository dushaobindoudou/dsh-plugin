...
[![npm](https://img.shields.io/npm/v/dsh-hub.svg)](https://www.npmjs.com/package/dsh-hub)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Local plugin hub for dsh installs** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Your inventory, not a marketplace - installed plugins, their dependency graph, and one-click updates.
