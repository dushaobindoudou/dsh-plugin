...
[![npm](https://img.shields.io/npm/v/dsh-storyboard.svg)](https://www.npmjs.com/package/dsh-storyboard)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Storyboard - the movie on paper** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Panels before production - the previsualization lane; Hitchcock shot the film on paper first.
