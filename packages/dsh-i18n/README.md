...
[![npm](https://img.shields.io/npm/v/dsh-i18n.svg)](https://www.npmjs.com/package/dsh-i18n)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Locale packs for the dsh web GUI** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Community translations for the DeepSeek Harness web UI - zh, en, ja, and more - as drop-in packs with per-profile selection.
