...
[![npm](https://img.shields.io/npm/v/dsh-qtum.svg)](https://www.npmjs.com/package/dsh-qtum)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Qtum - the bridging experiment** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Bitcoin UTXO meets ethereum EVM - the 2017 experiment from Singapore-Beijing.
