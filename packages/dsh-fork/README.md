...
[![npm](https://img.shields.io/npm/v/dsh-fork.svg)](https://www.npmjs.com/package/dsh-fork)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Session forking** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Fork a live session - full conversation state copied, both branches continue independently; the try-both-ways primitive.
