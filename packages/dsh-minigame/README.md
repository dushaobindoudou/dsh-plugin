...
[![npm](https://img.shields.io/npm/v/dsh-minigame.svg)](https://www.npmjs.com/package/dsh-minigame)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Minigame - the small complete game** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

A whole game in one screen - the generic seat of the minigame wall, from waiting rooms to super-apps.
