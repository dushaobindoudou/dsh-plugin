...
[![npm](https://img.shields.io/npm/v/dsh-embed.svg)](https://www.npmjs.com/package/dsh-embed)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Embedding pipeline for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Chunk, embed, and index workspace files - the ingestion side of retrieval, incremental by mtime, budget-capped per run.
