...
[![npm](https://img.shields.io/npm/v/dsh-mantle.svg)](https://www.npmjs.com/package/dsh-mantle)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Mantle - the bitdao chain** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The largest DAO treasury turned into a chain - the DAO-to-L2 lane.
