...
[![npm](https://img.shields.io/npm/v/dsh-brain.svg)](https://www.npmjs.com/package/dsh-brain)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The second brain for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Notes, memories, and connections - spaced-repetition reviews (anki-style), backlinks, and the daily recall that keeps knowledge alive.
