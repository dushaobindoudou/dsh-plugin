...
[![npm](https://img.shields.io/npm/v/dsh-drawdown.svg)](https://www.npmjs.com/package/dsh-drawdown)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Drawdown - from peak to pit** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

How far you fell and how long the climb back took - the honest metric no dashboard likes to show.
