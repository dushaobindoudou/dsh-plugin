...
[![npm](https://img.shields.io/npm/v/dsh-crispr.svg)](https://www.npmjs.com/package/dsh-crispr)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Crispr - the search and replace of life** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

A bacterial immune system turned genome editor - the editing lane; Nobel 2020, clinics now.
