...
[![npm](https://img.shields.io/npm/v/dsh-keyframe.svg)](https://www.npmjs.com/package/dsh-keyframe)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Keyframe - the pose, then the in-between** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Animation is interpolation between keys - the fundamentals lane; every timeline shares it.
