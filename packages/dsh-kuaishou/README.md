...
[![npm](https://img.shields.io/npm/v/dsh-kuaishou.svg)](https://www.npmjs.com/package/dsh-kuaishou)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Kuaishou (快手) channel bridge for dsh bots** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The other short-video giant - account reads, video digests, and live-commerce context; the Douyin twin every go-global plan forgets.
