...
[![npm](https://img.shields.io/npm/v/dsh-mocap.svg)](https://www.npmjs.com/package/dsh-mocap)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Mocap - performance into data** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Actors drive digital bodies - the motion-capture lane; Gollum was the proof.
