...
[![npm](https://img.shields.io/npm/v/dsh-qunliao.svg)](https://www.npmjs.com/package/dsh-qunliao)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Qunliao - the group chat** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

群聊 - where Chinese work and family actually happen; the many-to-many lane.
