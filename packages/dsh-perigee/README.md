...
[![npm](https://img.shields.io/npm/v/dsh-perigee.svg)](https://www.npmjs.com/package/dsh-perigee)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Perigee - the lowest pass** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The closest approach - kin to dsh-apogee; atmospheric drag lives here.
