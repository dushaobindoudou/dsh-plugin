...
[![npm](https://img.shields.io/npm/v/dsh-zcash.svg)](https://www.npmjs.com/package/dsh-zcash)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Zcash - the shielded pool** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Zero-knowledge payments since 2016 - the privacy lane with math; zk-snarks in production.
