...
[![npm](https://img.shields.io/npm/v/dsh-lookdev.svg)](https://www.npmjs.com/package/dsh-lookdev)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Lookdev - deciding how it appears** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Shaders and lighting studies - the art-direction lane; the look is a deliverable.
