...
[![npm](https://img.shields.io/npm/v/dsh-lyft.svg)](https://www.npmjs.com/package/dsh-lyft)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Lyft bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The other ride lane - price checks and trip digests over the Lyft API.
