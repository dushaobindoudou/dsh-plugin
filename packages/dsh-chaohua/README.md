...
[![npm](https://img.shields.io/npm/v/dsh-chaohua.svg)](https://www.npmjs.com/package/dsh-chaohua)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Chaohua - the super topic** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

超话 - the fan-community thread lane; fandom organizes itself here.
