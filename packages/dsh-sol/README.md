...
[![npm](https://img.shields.io/npm/v/dsh-sol.svg)](https://www.npmjs.com/package/dsh-sol)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The short form of the Solana bridge** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Compatibility name: the Solana bridge ships as dsh-solana; this form keeps the ticker spelling installable.
