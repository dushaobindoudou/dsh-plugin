...
[![npm](https://img.shields.io/npm/v/dsh-doubao.svg)](https://www.npmjs.com/package/dsh-doubao)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Doubao provider bridge for the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Volcengine Ark-served Doubao models as dsh providers, endpoint IDs resolvable by display name.
