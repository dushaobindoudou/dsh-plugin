...
[![npm](https://img.shields.io/npm/v/dsh-ox.svg)](https://www.npmjs.com/package/dsh-ox)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Ox - the endurance zodiac** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

丑牛 - plows through the largest task without complaint; the workhorse skin of the zodiac wall.
