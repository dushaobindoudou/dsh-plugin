...
[![npm](https://img.shields.io/npm/v/dsh-gonghai.svg)](https://www.npmjs.com/package/dsh-gonghai)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Gonghai (公海) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The public lead pool - China CRM culture in one word - reclaim rules enforced, idle leads recycled, the rotation nobody games.
