...
[![npm](https://img.shields.io/npm/v/dsh-curve.svg)](https://www.npmjs.com/package/dsh-curve)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Curve - the stable swap** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

AMM purpose-built for pegged assets - the deep-liquidity lane; CRV votes became an economy.
