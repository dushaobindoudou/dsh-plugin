...
[![npm](https://img.shields.io/npm/v/dsh-sui.svg)](https://www.npmjs.com/package/dsh-sui)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Sui bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Move-based chain reads - objects, packages, and transaction intent decoded for review.
