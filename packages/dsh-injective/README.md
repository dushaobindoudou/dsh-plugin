...
[![npm](https://img.shields.io/npm/v/dsh-injective.svg)](https://www.npmjs.com/package/dsh-injective)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Injective - the finance-specific chain** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

On-chain orderbooks and derivatives with MEV resistance - the exchange-chain lane.
