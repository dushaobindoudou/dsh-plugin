...
[![npm](https://img.shields.io/npm/v/dsh-tycoon.svg)](https://www.npmjs.com/package/dsh-tycoon)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Tycoon - the empire builder** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

From railroad barons to theme parks - build the machine that prints the score; the strategy-management lane.
