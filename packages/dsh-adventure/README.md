...
[![npm](https://img.shields.io/npm/v/dsh-adventure.svg)](https://www.npmjs.com/package/dsh-adventure)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Interactive fiction for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Text adventures generated and run live - the agent is dungeon master, the choices are yours.
