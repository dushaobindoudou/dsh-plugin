...
[![npm](https://img.shields.io/npm/v/dsh-pinduoduo.svg)](https://www.npmjs.com/package/dsh-pinduoduo)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Pinduoduo bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Group-buy reads - price watches, bargain alerts, and order tracking over the open API.
