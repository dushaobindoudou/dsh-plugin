...
[![npm](https://img.shields.io/npm/v/dsh-sinkhole.svg)](https://www.npmjs.com/package/dsh-sinkhole)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Sinkhole - where bad traffic dies** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Reroute malicious domains into a black hole - the containment lane; DNS-level defense.
