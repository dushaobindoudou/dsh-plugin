...
[![npm](https://img.shields.io/npm/v/dsh-btc.svg)](https://www.npmjs.com/package/dsh-btc)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Btc - the ticker that started it all** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The three letters every exchange lists first - the ticker seat of the original asset; dsh-bitcoin carries the name, this carries the tape.
