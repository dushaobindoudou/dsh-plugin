...
[![npm](https://img.shields.io/npm/v/dsh-habit.svg)](https://www.npmjs.com/package/dsh-habit)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Habit tracker for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Habit tracker for dsh. (Recorded from the npm registry at import time.)
