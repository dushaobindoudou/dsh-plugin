...
[![npm](https://img.shields.io/npm/v/dsh-dailies.svg)](https://www.npmjs.com/package/dsh-dailies)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Dailies - yesterday, watched today** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Rushes reviewed each morning - the editorial lane; decisions before noon.
