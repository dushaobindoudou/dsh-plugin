...
[![npm](https://img.shields.io/npm/v/dsh-planner.svg)](https://www.npmjs.com/package/dsh-planner)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Plan mode for dsh sessions** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Editable task trees the agent proposes and you approve - the plan stays visible, checkpoints rollback-able.
