...
[![npm](https://img.shields.io/npm/v/dsh-analyst.svg)](https://www.npmjs.com/package/dsh-analyst)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Data analyst role preset** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Questions before dashboards - the analyst persona that frames metrics, guards against survivorship bias, and writes SQL you can audit.
