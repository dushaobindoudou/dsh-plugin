...
[![npm](https://img.shields.io/npm/v/dsh-baoshui.svg)](https://www.npmjs.com/package/dsh-baoshui)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Baoshui (报关) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Customs declaration reads and drafts - HS codes matched, duty math checked, forms pre-filled from the order data; the trade lane fapiao does not cover.
