...
[![npm](https://img.shields.io/npm/v/dsh-yutu.svg)](https://www.npmjs.com/package/dsh-yutu)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Yutu (玉兔) - the jade rabbit** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The moon rabbit pounding medicine beside Chang e - the hardest-working creature in Chinese myth. A night-shift pet for overnight runs (dsh-overnight).
