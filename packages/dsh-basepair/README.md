...
[![npm](https://img.shields.io/npm/v/dsh-basepair.svg)](https://www.npmjs.com/package/dsh-basepair)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Basepair - A with T, G with C** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The pairing rule that makes DNA copyable - the fundamentals lane; two words that explain heredity.
