...
[![npm](https://img.shields.io/npm/v/dsh-tabletop.svg)](https://www.npmjs.com/package/dsh-tabletop)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Tabletop - around the table** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The English seat of the same category - dice, cardboard, and the friends across the table.
