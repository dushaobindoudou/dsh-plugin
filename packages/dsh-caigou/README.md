...
[![npm](https://img.shields.io/npm/v/dsh-caigou.svg)](https://www.npmjs.com/package/dsh-caigou)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Caigou (采购) lane for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Procurement as a workflow - requisition to PO, supplier quotes compared, approvals routed, the paper trail complete.
