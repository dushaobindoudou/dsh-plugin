...
[![npm](https://img.shields.io/npm/v/dsh-synthetix.svg)](https://www.npmjs.com/package/dsh-synthetix)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Synthetix - the synthetic engine** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Track any asset without holding it - the original derivatives protocol; kin to dsh-synthetic.
