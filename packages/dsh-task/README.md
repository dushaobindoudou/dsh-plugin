...
[![npm](https://img.shields.io/npm/v/dsh-task.svg)](https://www.npmjs.com/package/dsh-task)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Task board for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Task board for dsh. (Recorded from the npm registry at import time.)
