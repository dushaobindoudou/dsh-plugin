...
[![npm](https://img.shields.io/npm/v/dsh-joke.svg)](https://www.npmjs.com/package/dsh-joke)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Joke supply for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Joke supply for dsh. (Recorded from the npm registry at import time.)
