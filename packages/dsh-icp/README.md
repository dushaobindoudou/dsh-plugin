...
[![npm](https://img.shields.io/npm/v/dsh-icp.svg)](https://www.npmjs.com/package/dsh-icp)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Icp - the internet computer ticker** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Chain-key cryptography, canisters, web speed - the everything-on-chain ambition.
