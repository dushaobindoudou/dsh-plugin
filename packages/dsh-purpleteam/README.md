...
[![npm](https://img.shields.io/npm/v/dsh-purpleteam.svg)](https://www.npmjs.com/package/dsh-purpleteam)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Purpleteam - attack and defend together** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Red plus blue in the same room - the feedback lane that turns findings into fixes.
