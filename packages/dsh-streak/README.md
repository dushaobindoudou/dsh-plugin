...
[![npm](https://img.shields.io/npm/v/dsh-streak.svg)](https://www.npmjs.com/package/dsh-streak)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Streak - the run that ends** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Wins in a row, hits in a row - the momentum lane; the math says memoryless, the fans disagree.
