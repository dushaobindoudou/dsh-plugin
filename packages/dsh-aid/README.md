...
[![npm](https://img.shields.io/npm/v/dsh-aid.svg)](https://www.npmjs.com/package/dsh-aid)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Aid - the first responder** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The smallest help that arrives first - bandage before surgery; the quick-fix lane of the doctor family.
