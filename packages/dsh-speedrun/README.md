...
[![npm](https://img.shields.io/npm/v/dsh-speedrun.svg)](https://www.npmjs.com/package/dsh-speedrun)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Speedrun - any percent** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The same game, one record - routes, skips, frame-perfect tricks; the optimization lane for tasks done a thousand times.
