...
[![npm](https://img.shields.io/npm/v/dsh-critic.svg)](https://www.npmjs.com/package/dsh-critic)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Critic role for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The adversarial half of self-improvement - a second model grades the draft before it ships, weaknesses enumerated by rubric. Registered externally; promoted into the curated core.
