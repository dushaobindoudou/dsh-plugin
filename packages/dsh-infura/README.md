...
[![npm](https://img.shields.io/npm/v/dsh-infura.svg)](https://www.npmjs.com/package/dsh-infura)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Infura bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The classic RPC lane - Ethereum and IPFS reads behind one key, budget-capped per session.
