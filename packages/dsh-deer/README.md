...
[![npm](https://img.shields.io/npm/v/dsh-deer.svg)](https://www.npmjs.com/package/dsh-deer)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Deer - the gentle spirit form** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

小鹿 - the gentle forest seat; startles at errors, serene when all is well.
