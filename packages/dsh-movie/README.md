...
[![npm](https://img.shields.io/npm/v/dsh-movie.svg)](https://www.npmjs.com/package/dsh-movie)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Movie toolkit for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Movie toolkit for dsh. (Recorded from the npm registry at import time.)
