...
[![npm](https://img.shields.io/npm/v/dsh-me.svg)](https://www.npmjs.com/package/dsh-me)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The me seat for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The shortest personal pronoun in npm - one command for everything about you: profile (dsh-profile), preferences, twins, and history; your agent answers to it.
