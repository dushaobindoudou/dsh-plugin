...
[![npm](https://img.shields.io/npm/v/dsh-winstreak.svg)](https://www.npmjs.com/package/dsh-winstreak)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Winstreak - the hot hand** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Kin to dsh-streak; the lane where narratives test against regression.
