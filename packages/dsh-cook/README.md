...
[![npm](https://img.shields.io/npm/v/dsh-cook.svg)](https://www.npmjs.com/package/dsh-cook)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Cooking companion for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Cooking companion for dsh. (Recorded from the npm registry at import time.)
