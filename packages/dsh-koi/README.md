...
[![npm](https://img.shields.io/npm/v/dsh-koi.svg)](https://www.npmjs.com/package/dsh-koi)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Koi - the luck lane** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

锦鲤 - the forward-this-koi luck meme; the celebration form when everything succeeded on the first try.
