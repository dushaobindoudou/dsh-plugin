...
[![npm](https://img.shields.io/npm/v/dsh-singularitynet.svg)](https://www.npmjs.com/package/dsh-singularitynet)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Singularitynet - the AI marketplace** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

A thousand AI services with one token - the AGI-ambition lane; ASI founding member.
