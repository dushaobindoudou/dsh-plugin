...
[![npm](https://img.shields.io/npm/v/dsh-xiehouyu.svg)](https://www.npmjs.com/package/dsh-xiehouyu)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Xiehouyu - the two-part proverb** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

歇后语 - set up the image, deliver the twist; the pun form Chinese humor is built on.
