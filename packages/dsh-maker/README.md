...
[![npm](https://img.shields.io/npm/v/dsh-maker.svg)](https://www.npmjs.com/package/dsh-maker)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Maker - the original stablecoin engine** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Collateralized DAI since 2017 - the DAO that came back; now the sky family.
