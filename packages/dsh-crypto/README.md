...
[![npm](https://img.shields.io/npm/v/dsh-crypto.svg)](https://www.npmjs.com/package/dsh-crypto)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Crypto market tools for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Crypto market tools for dsh. (Recorded from the npm registry at import time.)
