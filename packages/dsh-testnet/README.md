...
[![npm](https://img.shields.io/npm/v/dsh-testnet.svg)](https://www.npmjs.com/package/dsh-testnet)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Testnet - the rehearsal chain** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

All the chaos, none of the cost - the staging environment of blockchains; break things here first.
