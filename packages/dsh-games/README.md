...
[![npm](https://img.shields.io/npm/v/dsh-games.svg)](https://www.npmjs.com/package/dsh-games)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Game night for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The plural lane - agents that play with you, not against you: word games, strategy, and party modes as scheduled breaks.
