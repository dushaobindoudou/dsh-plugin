...
[![npm](https://img.shields.io/npm/v/dsh-discord.svg)](https://www.npmjs.com/package/dsh-discord)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Discord bridge for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Discord bridge for dsh. (Recorded from the npm registry at import time.)
