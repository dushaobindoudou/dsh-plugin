...
[![npm](https://img.shields.io/npm/v/dsh-kyc.svg)](https://www.npmjs.com/package/dsh-kyc)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Kyc - know your wallet** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The permissioned lane - identity bound to the token; the price of permissionless is a whitelist somewhere.
