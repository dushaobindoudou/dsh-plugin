...
[![npm](https://img.shields.io/npm/v/dsh-ubereats.svg)](https://www.npmjs.com/package/dsh-ubereats)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Uber Eats bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Order tracking and favorite-spot digests over the Uber Eats lane.
