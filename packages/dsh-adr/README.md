...
[![npm](https://img.shields.io/npm/v/dsh-adr.svg)](https://www.npmjs.com/package/dsh-adr)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Adr - dialogue, again in a booth** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Automated dialogue replacement - the sound lane; cleaner lines, matching breath.
