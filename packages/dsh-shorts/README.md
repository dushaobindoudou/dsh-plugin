...
[![npm](https://img.shields.io/npm/v/dsh-shorts.svg)](https://www.npmjs.com/package/dsh-shorts)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Shorts - sell what you borrow** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The bear lane on-chain - borrow, sell, buy back; every market needs two directions.
