...
[![npm](https://img.shields.io/npm/v/dsh-shib.svg)](https://www.npmjs.com/package/dsh-shib)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Shib - the dogecoin successor** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The shiba army - the ecosystem lane that grew out of a joke; Shibarium included.
