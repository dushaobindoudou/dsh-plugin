...
[![npm](https://img.shields.io/npm/v/dsh-redemption.svg)](https://www.npmjs.com/package/dsh-redemption)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Redemption - the way back out** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Token to share to cash - the exit lane; an RWA is only as good as its redemption desk.
