...
[![npm](https://img.shields.io/npm/v/dsh-moonshot.svg)](https://www.npmjs.com/package/dsh-moonshot)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The company-spelled form of the Kimi provider bridge** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Compatibility name: the Kimi bridge ships as dsh-kimi; this form keeps the Moonshot AI company spelling installable.
