...
[![npm](https://img.shields.io/npm/v/dsh-compound.svg)](https://www.npmjs.com/package/dsh-compound)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Compound - interest rates as code** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The money market that named liquidity mining - the algorithmic-rate lane.
