...
[![npm](https://img.shields.io/npm/v/dsh-shangshi.svg)](https://www.npmjs.com/package/dsh-shangshi)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Shangshi - going public, in Chinese** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

上市 - the listing ceremony in two characters; the IPO lane in pinyin.
