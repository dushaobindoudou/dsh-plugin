...
[![npm](https://img.shields.io/npm/v/dsh-selfmod.svg)](https://www.npmjs.com/package/dsh-selfmod)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Self-modification with guardrails for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The agent editing its own code - every mutation a diff you review, with a one-command rollback and the test suite as the gate.
