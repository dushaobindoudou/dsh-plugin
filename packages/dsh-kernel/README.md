...
[![npm](https://img.shields.io/npm/v/dsh-kernel.svg)](https://www.npmjs.com/package/dsh-kernel)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**The kernel seat for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The innermost ring - session, scheduler, and policy primitives the rest of the stack calls; small enough to verify, stable enough to bet on.
