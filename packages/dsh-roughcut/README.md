...
[![npm](https://img.shields.io/npm/v/dsh-roughcut.svg)](https://www.npmjs.com/package/dsh-roughcut)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Roughcut - the story, unpolished** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Assembly to fine cut - the editorial lane; the film is found here.
