...
[![npm](https://img.shields.io/npm/v/dsh-instagram.svg)](https://www.npmjs.com/package/dsh-instagram)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Instagram channel bridge for dsh bots** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Post carousels and digests to Instagram - content drafted from run summaries, alt text included, human-approved before publish.
