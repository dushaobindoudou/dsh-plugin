...
[![npm](https://img.shields.io/npm/v/dsh-ml.svg)](https://www.npmjs.com/package/dsh-ml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**ML experiment toolkit for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

ML experiment toolkit for dsh. (Recorded from the npm registry at import time.)
