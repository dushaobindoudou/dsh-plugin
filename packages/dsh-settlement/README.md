...
[![npm](https://img.shields.io/npm/v/dsh-settlement.svg)](https://www.npmjs.com/package/dsh-settlement)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Settlement - finality at last** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The moment the money actually moves - finality lane; pending until proven final, in finance as in databases.
