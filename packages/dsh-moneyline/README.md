...
[![npm](https://img.shields.io/npm/v/dsh-moneyline.svg)](https://www.npmjs.com/package/dsh-moneyline)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Moneyline - just pick the winner** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

American odds on the straight result - the market lane; implied probability in three digits.
