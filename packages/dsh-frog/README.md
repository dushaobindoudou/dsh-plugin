...
[![npm](https://img.shields.io/npm/v/dsh-frog.svg)](https://www.npmjs.com/package/dsh-frog)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Frog - the patient form** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Sits perfectly still, then exactly one perfect jump - the form for watch modes; 呱.
