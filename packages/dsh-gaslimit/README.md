...
[![npm](https://img.shields.io/npm/v/dsh-gaslimit.svg)](https://www.npmjs.com/package/dsh-gaslimit)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Gaslimit - the ceiling on spend** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Set the maximum before the machine runs - the cost-control lane; also how agents should budget tool calls.
