...
[![npm](https://img.shields.io/npm/v/dsh-rigging.svg)](https://www.npmjs.com/package/dsh-rigging)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Rigging - the puppetry inside** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Bones, controls, constraints - the character-tech lane; animators need handles.
