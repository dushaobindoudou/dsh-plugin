...
[![npm](https://img.shields.io/npm/v/dsh-adsb.svg)](https://www.npmjs.com/package/dsh-adsb)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Adsb - every aircraft, broadcasting** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Automatic dependent surveillance - planes broadcast their position; the flight-tracking lane.
