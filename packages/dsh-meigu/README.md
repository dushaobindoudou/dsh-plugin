...
[![npm](https://img.shields.io/npm/v/dsh-meigu.svg)](https://www.npmjs.com/package/dsh-meigu)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Meigu - US stocks, in Chinese** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

美股 - the market a whole generation of Chinese investors watches at midnight; the pinyin seat of the tokenized-equity wall.
