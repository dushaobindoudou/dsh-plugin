...
[![npm](https://img.shields.io/npm/v/dsh-booking.svg)](https://www.npmjs.com/package/dsh-booking)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Booking.com bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Reservation reads and price-drop alerts over the Booking lane.
