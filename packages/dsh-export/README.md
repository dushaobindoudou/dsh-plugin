...
[![npm](https://img.shields.io/npm/v/dsh-export.svg)](https://www.npmjs.com/package/dsh-export)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Export sessions from the DeepSeek Harness** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Markdown, PDF, JSON - images and tool output inlined, one session or the whole home.
