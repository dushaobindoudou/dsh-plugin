...
[![npm](https://img.shields.io/npm/v/dsh-viem.svg)](https://www.npmjs.com/package/dsh-viem)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Viem-facing bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

TypeScript chain access as agent tools - the modern EVM client wired behind the approval seam.
