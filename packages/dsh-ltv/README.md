...
[![npm](https://img.shields.io/npm/v/dsh-ltv.svg)](https://www.npmjs.com/package/dsh-ltv)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Ltv - the loan to value line** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Eighty percent is safe, ninety is a countdown - the risk-parameter lane; every protocol lives or dies here.
