...
[![npm](https://img.shields.io/npm/v/dsh-netflix.svg)](https://www.npmjs.com/package/dsh-netflix)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Netflix bridge for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Watchlist reads and new-season alerts - the agent queues your evening, ratings cited as context.
