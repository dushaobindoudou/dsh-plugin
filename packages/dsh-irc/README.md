...
[![npm](https://img.shields.io/npm/v/dsh-irc.svg)](https://www.npmjs.com/package/dsh-irc)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**IRC bridge for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

IRC bridge for dsh. (Recorded from the npm registry at import time.)
