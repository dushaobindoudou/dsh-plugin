...
[![npm](https://img.shields.io/npm/v/dsh-calculator.svg)](https://www.npmjs.com/package/dsh-calculator)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Calculator tools for dsh** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Calculator tools for dsh. (Recorded from the npm registry at import time.)
