...
[![npm](https://img.shields.io/npm/v/dsh-reset.svg)](https://www.npmjs.com/package/dsh-reset)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Reset dsh profiles to a known state** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Snapshot before experimenting, restore after - the whole profile, not just settings.
