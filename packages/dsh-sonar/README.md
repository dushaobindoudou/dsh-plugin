...
[![npm](https://img.shields.io/npm/v/dsh-sonar.svg)](https://www.npmjs.com/package/dsh-sonar)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Sonar model bridge** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

Perplexity Sonar models as dsh providers - the search-grounded family behind dsh-perplexity, available model-by-model.
