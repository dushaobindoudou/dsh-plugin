...
[![npm](https://img.shields.io/npm/v/dsh-sushiswap.svg)](https://www.npmjs.com/package/dsh-sushiswap)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Sushiswap - the vampire attack** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The fork that flipped uniswap for a season - the liquidity-migration lane, a case study.
