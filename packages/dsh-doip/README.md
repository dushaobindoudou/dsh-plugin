...
[![npm](https://img.shields.io/npm/v/dsh-doip.svg)](https://www.npmjs.com/package/dsh-doip)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Doip - diagnostics over IP** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

OBD but over ethernet - the modern diagnostics lane; the scan tool is now a network peer.
