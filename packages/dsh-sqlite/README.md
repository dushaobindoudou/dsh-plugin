...
[![npm](https://img.shields.io/npm/v/dsh-sqlite.svg)](https://www.npmjs.com/package/dsh-sqlite)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**SQLite tools for dsh agents** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

SQLite tools for dsh agents. (Recorded from the npm registry at import time.)
