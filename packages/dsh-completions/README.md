...
[![npm](https://img.shields.io/npm/v/dsh-completions.svg)](https://www.npmjs.com/package/dsh-completions)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Shell completions for the dsh launcher** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).
