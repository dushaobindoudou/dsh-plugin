...
[![npm](https://img.shields.io/npm/v/dsh-eliza.svg)](https://www.npmjs.com/package/dsh-eliza)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](#license)

**Eliza - the agent framework** - a plugin for the [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`).

This package name is reserved; the first release is in development.

The open-source agent framework that took over crypto twitter - the swarm lane; our own lingxi kin.
